<?
	...
	class Core_EulaManager
	{
		...
		protected static function get_endpoint_url()
		{
			...
			return Phpr::$config->get('LS_EULA_GATEWAY', 'https://v1.lsdomainexpired.mjman.net/lsapp_eula/').$eula_type.'/';
		}
		...
		public static function commit($login = null, $first_name = null, $last_name = null)
		{
			...
			try 
			{
				...
				Core_Email::sendToList('core', 'accepted_agreement', $viewData, 'Updated LSAPP End User License Agreement has been accepted', $administrators);
			} catch (exception $ex) {}
		}

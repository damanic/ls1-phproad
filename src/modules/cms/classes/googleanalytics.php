...
class GoogleAnalytics
{
    ...
    public function load_keyfile($file_path)
    {
        if (!file_exists($file_path)) {
            throw new ApplicationException('Could not load Google Analytics key file');
        }
        ...
        if (!is_array($key_data_array) || !isset($key_data_array['client_email']) || $key_data_array['type'] !== 'service_account') {
            throw new ApplicationException('The Google authentication key file is not valid');
        }
    ...
    public function login()
    {
        ...
        try {
            ...
            $client->setApplicationName("LSAPP");

...
class PageNavigationNode
{
    ...
    /**
     * @var string Specifies the page URL, relative to LSAPP application root.
     * @documentable
     */
    public $url;
    ...
    {
        if (array_key_exists($this->id, Page::$navigation_parent_cache)) {
            return Page::$navigation_parent_cache[$this->id];
        }

...
class Module extends ModuleBase
{
    ...
    public function listTabs($tabCollection)
    {
        ...
        $tabs = array(
            'pages'=>array(
                'pages',
                'Pages',
                array('manage_pages', 'manage_page_content', 'manage_static_pages', 'manage_page_order')
            ),
            'templates'=>array(
                'templates',
                'Layouts',
    ...
    {
        Analytics::deleteStalePageviews();
    }
        
    public function listSettingsItems()
    {
        $maintenance_config = MaintenanceParams::create();
    ...
    {
        return ModuleParameters::get('cms', 'content_version', 0);
    }
    ...
    public static function update_cms_content_version()
    {
        ...
        ModuleParameters::set('cms', 'content_version', time());
    }
    ...
    {
        MaintenanceParams::handle_theme_activation($theme);
    }
}

	...
	class System_Backup_Archive extends Db_ActiveRecord 
	{
		...
		public function define_form_fields($context = null)
		{
			...
			if ($this->is_new_record())
				$this->add_form_field('archive_uploaded_dir')->comment('Enable this option if you want to include uploaded files (website resource files - images, CSS, JavaScript files, product and category images, etc.) to the archive. Enabling this option can significantly increase the backup file size. When this option is disabled LSAPP archives only the database content.');
		...
		/**
		 * Triggered before LSAPP {@link https://lsdomainexpired.mjman.net/docs/configuring_and_using_the_backup_system archive} is created.
		 * Example:
		 * <pre>
		 ...
		 * @see https://lsdomainexpired.mjman.net/docs/configuring_and_using_the_backup_system Configuring and using the backup system
		...
		/**
		 * Triggered after LSAPP {@link https://lsdomainexpired.mjman.net/docs/configuring_and_using_the_backup_system archive} is created.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
		...
		/**
		 * Triggered before LSAPP {@link https://lsdomainexpired.mjman.net/docs/configuring_and_using_the_backup_system archive} is restored.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {

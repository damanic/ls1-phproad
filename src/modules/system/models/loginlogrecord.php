...
class LoginLogRecord extends ActiveRecord
{
    ...
    {
        DbHelper::query('delete from system_login_log where datediff(NOW(), created_at) > 30');
        $obj = self::create();
    ...
    public function define_columns($context = null)
    {
        ...
        $this->define_relation_column('user_name', 'user', 'User', db_varchar, User::shortNameExpr);

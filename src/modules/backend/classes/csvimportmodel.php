...
class CsvImportModel extends ActiveRecord
{
    ...
    public $has_many = array(
        'csv_file' => array(
            ...
            'conditions'=>"master_object_class='Backend_CsvImportModel'",
            'order'=>'id',
            'delete'=>true
        ),
        'config_import' => array(
    ...
    public function define_form_fields($context = null)
    {
        $this->add_form_field('csv_file', 'left')
            ...
            ->addDocumentLabel('Upload a file')
            ->fileDownloadBaseUrl(url('ls_backend/files/get/'))
            ->noAttachmentsLabel('');

        $this->add_form_field('config_import', 'left')
            ->renderAs(frm_file_attachments)
            ->renderFilesAs('single_file')
            ->addDocumentLabel('Upload a file')
            ->fileDownloadBaseUrl(url('ls_backend/files/get/'))

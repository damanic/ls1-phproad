...
class Statuses extends SettingsController
{
    ...
    public $list_model_class = 'Shop\OrderStatus';
    public $list_record_url = null;

    public $form_create_title = 'New Status';
    public $form_edit_title = 'Edit Status';
    public $form_model_class = 'Shop\OrderStatus';
    ...
    protected function onAddTransition($stateId = null)
    {
        try {
            ...
            $transitionData = post(get_class_id('Shop\StatusTransition'));
            foreach ($transitions as $existingTransition) {
                if ($existingTransition->to_state_id == $transitionData['to_state_id']
                    ...
                    throw new ApplicationException('Transition with selected parameters already exists.');
                }
            }
    ...
    protected function onDeleteTransition($stateId = null)
    {
        try {
            ...
            $transition = StatusTransition::create()->find(post('transitionId'));
            if ($transition) {

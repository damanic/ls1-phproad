...
class Extras_Sets extends Controller
{
    public $implement = 'Db_ListBehavior, Db_FormBehavior';
    public $list_model_class = 'Shop\ExtraOptionSet';
    ...
    public $form_model_class = 'Shop\ExtraOptionSet';
    ...
    protected function onSetExtraGroupName()
    {
        try {
            ...
            $this->preparePartialRender('form_field_container_group_name$classId');

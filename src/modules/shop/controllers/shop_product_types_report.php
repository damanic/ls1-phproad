<?php
	...
	class Shop_Product_Types_Report extends Shop_GenericReport
	{
		...
		protected function getChartData(){
			...
			if ($displayType == 'amount')
				$amountField = 'sum(((shop_order_items.price+shop_order_items.extras_price)*shop_order_items.quantity-shop_order_items.discount)* shop_orders.shop_currency_rate)';
			else

...
class Custom_Groups_Report extends GenericReport
{
    ...
    public $filter_filters = array(
        ...
        'groups' => array(
            'name' => 'Group',
            'class_name' => 'Shop\CustomGroupExactFilter',
            'cancel_if_all' => false,
            'prompt' =>
    ...
    protected $timeline_charts = array(ChartController::rt_line);
    ...
    public function getChartData()
    {
        ...
        if ($chartType == ChartController::rt_column || $chartType == ChartController::rt_pie) {
            ...
            $data_query = "
				...
				left join shop_products_customgroups 
				    on shop_products_customgroups.shop_product_id=(
				        if(
				            shop_products.grouped is null or shop_products.grouped=0, 
				            shop_products.id, 
				            shop_products.product_id
            ...
            $data_query = "
					...
					left join shop_custom_group 
					    on shop_custom_group.id = shop_products_customgroups.shop_custom_group_id
					left join shop_customers on shop_customers.id=shop_orders.customer_id
    ...
    protected function renderReportTotals()
    {
        ...
        $query_str = "from shop_orders, shop_order_statuses, shop_order_items, shop_products
				...
				and exists(
				    select shop_custom_group.id from shop_custom_group, 
				    shop_products_customgroups 
				    where shop_products_customgroups.shop_product_id = (
				        if(
				            shop_products.grouped is null or shop_products.grouped=0, 
				            shop_products.id, 
				            shop_products.product_id
				    ...
				    and shop_custom_group.id = shop_products_customgroups.shop_custom_group_id $group_filter
				)

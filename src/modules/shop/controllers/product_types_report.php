...
class Product_Types_Report extends GenericReport
{
    ...
    public $filter_filters = [
        ...
        'products' => [
            ...
            'prompt' =>
                'Please choose products you want to include to the report. All other products will be excluded.',
    ...
    public function index()
    {
        ...
        $this->viewData['report'] = 'product_types';
    ...
    protected function getChartData()
    {
        ...
        if ($displayType == 'amount') {
            $amountField = 'sum(
            ((shop_order_items.price+shop_order_items.extras_price)*shop_order_items.quantity-shop_order_items.discount)
        ...
        if ($chartType == ChartController::rt_column || $chartType == ChartController::rt_pie) {
            ...
            $data_query = "
				...
				left join shop_product_types on shop_product_types.id=shop_products.product_type_id
				...
				where
					...
					$filterStr
					$paidFilter
				group by shop_product_types.id";
        } else {
            ...
            $data_query = "
					...
					group by {$seriesIdField}, shop_product_types.id
					order by report_date, shop_product_types.id
				";
    ...
    protected function renderReportTotals()
    {
        ...
        and shop_products.id = shop_order_items.shop_product_id 

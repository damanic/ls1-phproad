...
class Reviews extends Controller
{
    ...
    public $list_search_fields = ['product_link_calculated_join.name'];
    ...
    {
        if ($model->prv_moderation_status == ProductReview::status_new) {

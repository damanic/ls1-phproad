...
class Categories_Report extends GenericReport
{
        ...
        if ($chartType == ChartController::rt_column || $chartType == ChartController::rt_pie) {
            ...
            $data_query = "
				...
				left join shop_products_categories 
				    on shop_products_categories.shop_product_id=(
				        if(
    ...
    protected function renderReportTotals()
    {
        ...
        $query =
			...
			(select sum(((shop_order_items.price+shop_order_items.extras_price-shop_order_items.discount)
			    *shop_order_items.quantity) * shop_orders.shop_currency_rate) $query_str) as amount";

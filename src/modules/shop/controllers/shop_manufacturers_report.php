<?php
	...
	class Shop_Manufacturers_Report extends Shop_GenericReport
	{
		...
		public function listPrepareData()
		{
			...
			$obj->where('(exists (select shop_products.id from shop_products, shop_order_items, shop_manufacturers where shop_products.id=shop_order_items.shop_product_id and shop_order_items.shop_order_id=shop_orders.id and shop_manufacturers.id=if(

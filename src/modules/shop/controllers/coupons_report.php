...
class Coupons_Report extends GenericReport
{
    ...
    protected function renderReportTotals()
    {
        ...
        $query_str = "from shop_orders, shop_order_statuses, shop_customers
			...
			and shop_orders.coupon_id is not null 
        ...
        $query = "
				...
				(
				    select sum(
				    (total - goods_tax - shipping_tax - shipping_quote) * shop_orders.shop_currency_rate) 
				    $query_str
				 ) as revenue,

...
use Db\Helper as DbHelper;
    ...
    $countries = [
        ...
        ['Aland Islands ﻿ Åland Islands', 'AX', 'ALA', '248'],
        ['Albania', 'AL', 'ALB', '008'],
        ['Algeria', 'DZ', 'DZA', '012'],
    ...
    foreach ($countries as $info) {
        $exists = DbHelper::scalar('select count(*) from shop_countries where code_3=:code_3', ['code_3'=>$info[2]]);
        if ($exists) {
            continue;
        }
        ...
        DbHelper::query(
            'insert into shop_countries(code, name, code_3, code_iso_numeric, enabled) 
                 values (:code, :name, :code_3, :code_iso_numeric, 0)',
            [
            'code'=>$info[1],
            'name'=>$info[0],
            'code_3'=>$info[2],
            'code_iso_numeric'=>$info[3]
            ]);
    }

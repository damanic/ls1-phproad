...
class ProductToFixedPrice_Action extends RuleActionBase
{
    ...
    {
        $host_obj->add_field('discount_amount', 'Price', 'full', db_float)
            ->comment('Please specify a fixed price to apply to the product.', 'above')
            ->validation()

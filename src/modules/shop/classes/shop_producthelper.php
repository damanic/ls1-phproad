<?php
	...
	class Shop_ProductHelper
	{
		 ...
		 * set corresponding to the first <em>enabled</em> {@link https://lsdomainexpired.mjman.net/docs/integrating_option_matrix Option Matrix} record. 
		 ...
		 * or POSTed when a visitor selects another option on the {@link https://lsdomainexpired.mjman.net/docs/product_page/ product details} page.
		 * @documentable

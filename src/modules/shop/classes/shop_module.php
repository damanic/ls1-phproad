		...
		public function listEmailVariables()
		{
			...
			return array(
				...
				'Order variables'=>array(
					...
					'order_id'=>array('Outputs order ID', '100'),
					'order_reference'=>array('Outputs order reference', '100'),
				...
				'Product review'=>array(
					...
					'review_product_name'=>array('Outputs a name of the product the review is written for', 'LSAPP'),

...
namespace Shop;
     ...
     * exchange rates.
     */
abstract class CurrencyConverterBase
{
    /**
     ...
     * @param $host_obj \Db\ActiveRecord  Record object to read parameters from
     ...
     *
     * @param $host_obj \Db\ActiveRecord object to add fields to
     */

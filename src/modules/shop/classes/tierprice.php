...
class TierPrice
{
    ...
    public static function list_tier_prices_from_string($str, $product_name)
    {
        ...
        try {
            ...
            throw new ApplicationException('Error loading tier prices for the "' . $product_name . '" product');
        }
    }
     ...
     */
    public static function eval_tier_price(
        $str,
        $group_id,
        $quantity,
        $product_name,
    ...
    protected static function find_parent_tier(&$tiers, $tier_id)
    {
        ...
        return PriceTier::find_by_id($tier_id);
    }
}

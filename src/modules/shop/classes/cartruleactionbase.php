...
class CartRuleActionBase extends RuleActionBase
{
     ...
     */
    protected function is_active_for_product(
        $product,
        $product_conditions,
     ...
     * @param array $item_discount_tax_incl_map A list of cart item identifiers and corresponding
     *              discounts with tax included.
     * @param RuleConditionBase $product_conditions Specifies product conditions to filter the products

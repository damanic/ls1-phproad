<?
	 ...
	 * {@link Shop_Cart} class. Please read the {@link https://lsdomainexpired.mjman.net/docs/cart_page/ Creating the Cart page} 
	...
	class Shop_CartItem implements Shop_RetailItem, Shop_BundleItem
	{
		 ...
		 * @param boolean $force_tax Determines whether taxes should be added to the result, overriding {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} option status.
		 ...
		 * {@link https://lsdomainexpired.mjman.net/docs/allowing_customers_to_provide_order_item_specific_information/ this article}. 
		 * Example: 
		 * <pre>
		 * <textarea 
		...
		/**
		 * Returns a list of files uploaded by the customer on the {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ Product Details page}. 
		 * Use this method to display files assigned with items on the {@link https://lsdomainexpired.mjman.net/docs/cart_page Cart page}. 

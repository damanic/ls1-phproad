<?
	 ...
	 * dimensions and weight of the cart items. Please read the {@link https://lsdomainexpired.mjman.net/docs/cart_page/ Creating the Cart page} article for examples of 
	 * the class usage.
	 * 
	 ...
	 * order to place an item into a specific cart. By default LSAPP always work with the shopping cart named <em>main</em>.
	 * @documentable
	...
	class Shop_Cart
	{
		 ...
		 * @param array $custom_data Contains item {@link https://lsdomainexpired.mjman.net/docs/allowing_customers_to_provide_order_item_specific_information/ custom fields} data.
		 ...
		 *   <li><em>custom_data</em> - an array of {@link https://lsdomainexpired.mjman.net/docs/allowing_customers_to_provide_order_item_specific_information/ custom API field} names and values.</li>
		 *   <li><em>bundle_data</em> - an array containing {@link https://lsdomainexpired.mjman.net/docs/displaying_product_bundle_items/ bundle product data}.</li>

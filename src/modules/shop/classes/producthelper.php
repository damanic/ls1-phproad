 ...
 * for displaying product details information.
 * @documentable
...
{
    /**
     * Returns a list of selected product options suitable for passing to {@link Product::om()} method.
     ...
     * <em>enabled</em> {@link https://lsdomainexpired.mjman.net/docs/integrating_option_matrix Option Matrix} record.
     * If the parameter value is FALSE, the method returns an option set corresponding
     * to the first <em>existing</em> Option Matrix product.
     *
     ...
     * @param Product $product Specifies a product to return options for.

...
class RuleIfCondition extends RuleCompoundConditionBase
{
    ...
    {
        $result = $parameters_host->condition_type == 0 ? 'ALL ' : 'ANY ';
        $result .= 'sub-conditions should be ';
    ...
    {
        $options = array(
            '0'=>'ALL sub-conditions should meet the requirement',
            '1'=>'ANY sub-condition should meet the requirement'
        );

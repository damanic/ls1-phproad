<?
	...
	class Shop_AddressInfo
	{
		 ...
		 * The default shipping location can be configured on {@link https://lsdomainexpired.mjman.net/docs/configuring_the_shipping_parameters/ Shipping Configuration} page.
		 * @documentable

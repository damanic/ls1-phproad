 ...
 * @documentable
 * @see https://lsdomainexpired.mjman.net/docs/managing_payment_transactions Managing payment transactions
 * @see PaymentMethod
 * @package shop.models
 * @author LSAPP - MJMAN
 */
class TransactionUpdate
{
    ...
    /**
     * @var array of TransactionDisputeUpdate
    ...
    public function add_dispute(TransactionDisputeUpdate $dispute)
    {

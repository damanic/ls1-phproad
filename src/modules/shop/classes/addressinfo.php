...
class AddressInfo
{
    ...
    /**
     * @var int Specifies the country identifier.
     ...
     * <pre>
     *   $country = Country::find_by_id($address_info->country);
     *   if ($country)
     *     echo h($country->name);
     * </pre>
     * @documentable
    ...
    /**
     * @var int Specifies the state identifier.
     ...
     * <pre>
     *   $state = CountryState::find_by_id($address_info->state);
     *   if ($state)
     *     echo h($state->name);
     * </pre>
     * @documentable
    ...
    /**
     * Loads address information from a {@link Customer customer} object.
     * @documentable
     * @param Customer $customer Specifies a customer object to load address information from.
     */
    ...
    /**
     * Saves address information to a {@link Customer customer} object.
     * The method doesn't save the customer object to the database.
     * @documentable
     * @param Customer $customer Specifies a customer object to save address information to.
     */
    ...
    /**
     * Loads address information from a {@link Order customer} object.
     * @documentable
     * @param Customer $customer Specifies a customer object to load address information from.
     */
    ...
    /**
     * Saves address information to an {@link Order order} object.
     * The method doesn't save the order object to the database.
     * @documentable
     * @param Order $order Specifies an order object to save address information to.
     */
    ...
    /**
     * Checks whether the address represented with the object matches
     * the address represented with another address information object.
     * @documentable
     * @param AddressInfo $address_info Specifies another address information object to compare with.
    ...
    /**
     * Copies the address from another AddressInfo object.
     * @documentable
     * @param AddressInfo $address Specifies the address information object to copy the address from.
     */
     ...
     * The default shipping location can be configured on
     * {@link https://lsdomainexpired.mjman.net/docs/configuring_the_shipping_parameters/ Shipping Configuration} page.
     * @documentable
     ...
     *
     * @return AddressInfo Returns an address info object with transliterated values
     */

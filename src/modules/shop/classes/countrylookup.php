...
class CountryLookup
{
    ...
    public static function get_usps_name($iso)
    {
        ...
        $name = DbHelper::scalar(
            'select usps_name from shop_country_lookup where iso_code=:code',
            array(
                'code'=>$iso
            )
        );
    ...
    * @return bool return true if USPS domestic shipping should be used, false if international shipping
    */
    public static function get_usps_domestic($iso)
    {
        ...
        $is_domestic = DbHelper::scalar(
            'select usps_domestic from shop_country_lookup where iso_code=:code',
            array(
            'code'=>$iso
            )
        );

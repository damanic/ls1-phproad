 ...
 * Normally you don't need to create instances of that class. LSAPP provides the access to the class object
 ...
 */
class CheckoutAddressInfo extends AddressInfo
{
     ...
     * @param bool Determines use of billing address or shipping address.
     */
     ...
     * @documentable
     *
     * @param Customer $customer Specifies the customer object if it is presented.
     */

 ...
 * For retail items that support product bundle offers  (@see ProductBundleOffer)
...
interface BundleItemInterface {
     ...
     * @documentable
     * @return array Returns an array of {@link RetailItemInterface} compatible objects.
     */
     ...
     * @return mixed Returns the ProductBundleOffer associated with this item, or NULL
     */

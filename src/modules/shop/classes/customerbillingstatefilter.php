...
class CustomerBillingStateFilter extends DataFilter
{
    public $model_class_name = 'Shop\CountryState';
    ...
    public function applyToModel($model, $keys, $context = null)
    {
        if ($context != 'product_report') {
            ...
            $model->where('shop_orders.billing_state_id in (?)', array($keys));
        }
    }
        
    public function asString($keys, $context = null)
    {
        return 'and shop_orders.billing_state_id in '.$this->keysToStr($keys);
    }
}

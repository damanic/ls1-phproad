	...
	class Shop_PaymentTransaction extends Db_ActiveRecord
	{
		...
		public function update_transaction_status($order, $new_transaction_status_code, $new_order_status_id, $comment)
		{
			...
			} catch (Exception $ex)
			{
				...
				$message = "The transaction has been successfully updated on the payment gateway, but an error occurred during updating the transaction status in the LSAPP database: ".$message;

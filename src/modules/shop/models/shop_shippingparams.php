<?php
	...
	class Shop_ShippingParams extends Db_ActiveRecord 
	{
		...
		public function define_form_fields($context = null)
		{
			...
			$this->add_form_field('display_shipping_service_errors')->tab('Parameters')->comment('Display shipping service errors like "Please specify a valid ZIP code" on the front-end website. This feature should be implemented in the front-end partials. Please refer to the <a href="https://lsdomainexpired.mjman.net/docs/creating_shipping_method_partial/" target="_blank">documentation</a> for details.', 'above', true);

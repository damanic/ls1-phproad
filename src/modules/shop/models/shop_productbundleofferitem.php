<?php
	...
	class Shop_ProductBundleOfferItem extends Db_ActiveRecord
	{
		 ...
		 * @param array $product_options Specifies selected product options ({@link https://lsdomainexpired.mjman.net/docs/understanding_option_matrix/ Option Matrix} support)
		 ...
		 * the product assigned to the item will be used. If you use {@link https://lsdomainexpired.mjman.net/docs/understanding_option_matrix/ Option Matrix} 
		 * feature, pass selected bundle item product's options to the second parameter. Use {@link Shop_BundleHelper::get_selected_options()} 
		 * method to load the selected options. Example: 
		 * <pre>
		 * $selected_options = Shop_BundleHelper::get_selected_options($item, $item_product);

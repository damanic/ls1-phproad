<?
	 ...
	 * See the {@link https://lsdomainexpired.mjman.net/docs/order_details_page Creating the Order Details page} article for examples of the class usage.
	...
	class Shop_ProductFile extends Db_File
	{
		 ...
		 * Please refer the {@link https://lsdomainexpired.mjman.net/docs/order_details_page Creating the Order Details page}
		 ...
		 * {@link https://lsdomainexpired.mjman.net/docs/implementing_downloadable_products/ Integrating downloadable products} article.
		 * 

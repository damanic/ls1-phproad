<?
	 ...
	 * By default LSAPP does not return shipping options with errors. You can enable this feature on the System/Settings/Shipping 
	...
	class Shop_ShippingOption extends Shop_ActiveRecord
	{
		...
		public function define_columns($context = null)
		{
			...
			$this->define_column('ls_api_code', 'LSAPP API Code')->defaultInvisible()->validation()->fn('trim')->fn('mb_strtolower')->unique('Shipping option with the specified LSAPP API code already exists.');
		...
		*      depending on the caller context. When processing existing orders, LSAPP can automatically convert order items to cart 

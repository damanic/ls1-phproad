<?php
	...
	class Shop_OptionMatrixRecord extends Db_ActiveRecord implements Db_MemoryCacheable
	{
		 ...
		 * if the {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} 
		 ...
		 * @param boolean $no_tax Forces the function to not include tax into the result even if the {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} option is enabled.

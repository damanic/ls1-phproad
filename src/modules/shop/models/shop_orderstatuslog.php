<?php
	...
	class Shop_OrderStatusLog extends Db_ActiveRecord
	{
		 ...
		 * notifications are allowed by the {@link https://lsdomainexpired.mjman.net/docs/configuring_the_order_route_and_user_roles order route}.
		 * 
		 * The behavior of this method can be altered by {@link shop:onOrderBeforeStatusChanged} event handlers.
		 * @documentable
		 * @see https://lsdomainexpired.mjman.net/docs/configuring_the_order_route_and_user_roles Configuring the order route and user roles
		 ...
		 * @param boolean $send_notifications Determines whether notifications should be sent to the customer and LSAPP users.
		...
		public function define_form_fields($context = null)
		{
			...
			$field = $this->add_form_field('send_notifications')->comment('Send notifications to customer(s) and LSAPP users in accordance with the order route settings.', 'above');
			if ($context != 'multiorder')
				$field->tab('Status');

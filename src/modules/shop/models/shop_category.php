<?php
	 ...
	 * as well as a list of the category products. The category class is {@link https://lsdomainexpired.mjman.net/docs/performance_tuning/ proxiable}.
	 *
	...
	class Shop_Category extends Db_ActiveRecord
	{
		 ...
		 * Please read the {@link https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products Displaying a list of products} article for the examples.
		 * 

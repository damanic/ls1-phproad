 ...
 * @property string $meta_description Specifies the product description for outputting in the HTML META element on the {@link https://lsdomainexpired.mjman.net/docs/product_page product details page}.
 * @property string $meta_keywords Specifies the product keywords for outputting in the HTML META element on the {@link https://lsdomainexpired.mjman.net/docs/product_page product details page}.
 ...
 * Please read the {@link https://lsdomainexpired.mjman.net/docs/displaying_product_options Displaying Product Options} article for details and code examples.
 ...
 * @see https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_grouped_products/ Displaying a list of grouped products
 * @package shop.models
 * @author LSAPP - MJMAN
 */
...
//			'related_product_list'=>array('class_name'=>'Shop_Product', 'join_table'=>'shop_related_products', 'primary_key'=>'master_product_id', 'foreign_key'=>'related_product_id', 'conditions'=>'shop_products.enabled=1')
	 ...
	 * If there are no {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules} applied to the product and there
	 * is no sale price specified for the product, the method returns the product base price.
	 * The price can include tax if the {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax}
	 * option is enabled
	 *
	...
	/**
	 * Determines whether the product is on sale.
	 * Products considered on sale if there are any active {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules}
	 ...
	 * For products which use {@link https://lsdomainexpired.mjman.net/docs/integrating_option_matrix Option Matrix} the base product
	 ...
	 * The price depends on price tiers and does not depend on {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules}.
	...
	/**
	 * Returns a {@link https://lsdomainexpired.mjman.net/docs/product_page/ product page} URL, based on the URL passed in the parameter.
	 ...
	 * {@link https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products Displaying a list of products} article for the usage example.
	 * @documentable
	 * @see https://lsdomainexpired.mjman.net/docs/product_page/ Product page
	 * @see https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products Displaying a list of products
	 ...
	 * The <em>$default_product_url</em> parameter should contain an URL of a default {@link https://lsdomainexpired.mjman.net/docs/product_page/ product page}
	...
	/**
	 * Returns a list of products on sale.
	 * Products on sale include products with any {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules} applied
	 ...
	 * This method is applicable only on the {@link https://lsdomainexpired.mjman.net/docs/product_page Product Details} page. Please see
	 * {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ Supporting file uploads on the product page} article for details.
	 * @documentable
	 * @see https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ Supporting file uploads on the product page
	 ...
	 * You can download a module template extending the product model in {@link https://lsdomainexpired.mjman.net/docs/lemonstand_module_templates Module Templates}
	...
	/**
	 * Triggered before a file is added to a product on the {@link https://lsdomainexpired.mjman.net/docs/product_page Product Details} page.
	 * Inside the event handler you can validate the uploaded file and trigger an exception if it is needed.
	 * Please read {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ this article} to learn about
	...
	/**
	 * Triggered after a file is added to a product on the {@link https://lsdomainexpired.mjman.net/docs/product_page Product Details} page.
	 * Please read {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ this article} to learn about
	 * implementing the file upload support on the product details page.
	 * Example:
	 * <pre>

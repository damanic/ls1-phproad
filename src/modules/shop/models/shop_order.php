...
//				$this->add_form_custom_area('tax_summary')->tab('Order Details')->noForm();
	 ...
	 * This method is used by {@link https://lsdomainexpired.mjman.net/docs/developing_payment_modules payment modules} internally.
	 * @documentable
	...
	/**
	 * Returns TRUE if the order has {@link https://lsdomainexpired.mjman.net/docs/understanding_the_paid_order_status/ Paid status}, or the Paid status is in the order status history.
	 ...
	 * but you (a merchant) have not validated the payment and have not sent the order into the {@link https://lsdomainexpired.mjman.net/docs/understanding_the_paid_order_status/ Paid status}
	 * (the {@link Shop_Order::is_paid() is_paid()} method will return FALSE). Payment methods in LSAPP can be configured
	 ...
	 *
	 * The common usage for the payment_processed() method is hiding the Pay button on the {@link https://lsdomainexpired.mjman.net/docs/order_details_page order details page}.
	 ...
	 * </ul>
	 * Use this method for displaying a list of order taxes on the order {@link https://lsdomainexpired.mjman.net/docs/payment_receipt_page receipt page},
	 * for example:
	 * <pre>
	 * Applied sales taxes:
	...
	public static function get_rss($record_number = 20)
	{
		...
		$rss = new Core_Rss( 'LSAPP Order List',
	...
	*/
	 ...
	 * related to invoices. Some modules, for example {@link https://lsdomainexpired.mjman.net/docs/subscriptions_module Subscriptions Module},
	 ...
	 * Similar code used in the {@link https://lsdomainexpired.mjman.net/docs/subscriptions_module Subscriptions Module}.
	 * <pre>
	 * public function subscribeEvents()
	 * {

 ...
 * @property PhprDateTime $created_at Specifies the date and time when the profile record was created.
 * @property PhprDateTime $updated_at Specifies the date and time when the profile record was updated last time.
 * @see https://lsdomainexpired.mjman.net/docs/implementing_customer_payment_profiles
 ...
 * @author LSAPP - MJMAN
 */
class CustomerPaymentProfile extends ActiveRecord
{
     ...
     * @package shop.events
     * @author LSAPP - MJMAN
     * @param CustomerPaymentProfile $profile Specifies the profile object.
     */

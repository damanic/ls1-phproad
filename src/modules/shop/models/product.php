 ...
 *
 * @property bool $allow_pre_order Indicates whether the product inventory tracking settings allow pre-ordering.
 * You can use this field value for detecting whether the <em>Add to Cart</em> button should be visible on the
 * {@link https://lsdomainexpired.mjman.net/docs/product_page product details page}. Usage example:
 * <pre>
 * <? if (!$product->is_out_of_stock() || $product->allow_pre_order): ?>
 *    ... Add to Cart button ...
 * <? endif ?>
 * </pre>
 * @property DataCollection $category_list A list of categories the product belongs to.
 * Each element in the collection is an object of {@link Category} class.
 * @property PhprDateTime $created_at Specifies a date and time when the product has been added to the database.
 ...
 * @property bool $disable_completely Determines whether the product and all its grouped products are disabled
 *  (overrides the {@link Product::enabled enabled} property).
 *  Completely disabled products are displayed in the product list in the Administration Area,
 *  but not displayed in other lists (Discounts, etc.).
 * @property bool $enabled Determines whether the product is enabled.
 * See also {@link Product::disable_completely disable_completely} property.
 * @property PhprDateTime $expected_availability_date Specifies the date of the product's expected availability.
 ...
 * <? endif ?>
 * </pre>
 * @property DataCollection $extra_options A collection of the product extra options.
 * Each element in the collection is {@link ExtraOption} object.
 * @property DataCollection $files A list of files associated with the product.
 * Files can be associated only with downloadable products.
 * Each element of the collection is an object of the {@link ProductFile} class.
 * @property string $grouped_menu_label Specifies a label for the grouped products option list,
 * for example <em>"Color"</em>.
 * A value of this field is specified in the <em>Attribute Name</em>
 * field of the Create/Edit Product form in the Administration Area, on the Grouped tab.
 * @property string $grouped_option_desc Specifies a description of the product in the list of grouped products,
 * for example <em>"Green"</em>.
 * @property DataCollection $grouped_products A list of grouped products associated with the product.
 * Use this list for displaying a list of grouped products on the product page.
 * Each element in the collection is {@link Product} object.
 * @property float $height Specifies the product height.
 * @property int $id Specifies the product identifier in the database.
 * @property DataCollection $images A collection of the product images.
 * Each element in the collection is an object of the {@link File} class.
 * @property int $in_stock Indicates how many units of the products are available in stock.
 * See also the {@link Product::in_stock_grouped() in_stock_grouped()} method.
 * @property Manufacturer $manufacturer Specifies the product manufacturer.
 * This field can be NULL if a manufacturer is not specified for the product.
 * @property Product $master_grouped_product Specifies a reference to the parent grouped product.
 * @property string $meta_description Specifies the product description for outputting in the HTML META element on the
 * {@link https://lsdomainexpired.mjman.net/docs/product_page product details page}.
 * @property string $meta_keywords Specifies the product keywords for outputting in the HTML META element on the
 * {@link https://lsdomainexpired.mjman.net/docs/product_page product details page}.
 * @property string $name Specifies the product name.
 * @property DataCollection $options Contains a list of product options.
 * Each element in the collection is an object of {@link CustomAttribute} class.
 * Please read the {@link https://lsdomainexpired.mjman.net/docs/displaying_product_options Displaying Product Options}
 * article for details and code examples.
 * @property int $product_id Specifies identifier of a parent product for a grouped product.
 * @property float $rating_all Specifies a rating based on all reviews, included non-approved.
 * @property int $rating_all_review_num Specifies a number of <em>all</em> reviews with a rating specified.
 ...
 * rating information available for the product.
 * Values have increment of 0.5 i.e.: 1, 1.5, 2, 2.5, 3, 3.5, 4. 4,5, 5.
 * There is no 0.5 value, because the minimal rating a visitor can set is 1.
 * @property int $rating_review_num Specifies a number of <em>approved</em> reviews with rating specified.
 * You can use this filed for displaying the "Based on 8 reviews" text near the product rating value.
 * @property DataCollection $related_products A list of related products.
 * Each element of the collection is an object of Product class.
 * The collection contains all enabled and available related products,
 * but ignores product visibility filters (customer group filter, etc).
 * If you want to obtain a list of related products with visibility
 * filters applied, please use the {@link Product::list_related_products() list_related_products()} method.
 ...
 * @property TaxClass $tax_class Specifies a tax class the product belongs to.
 ...
 * need to access the field directly. Use the {@link Product::page_url() page_url()} method for creating links to
 * {@link https://lsdomainexpired.mjman.net/docs/product_page product pages}.
 * @property bool $visibility_catalog Determines whether product should be visible in the catalog.
 * This field affects the {@link Category::list_products()} and {@link CustomGroup::list_products()} methods.
 * @property bool $visibility_search Determines whether product should be visible in search results.
 * This field affects the {@link Product::find_products() find_products()} method behavior.
 * @property float $weight Specifies the product weight.
 * @property float $width Specifies the product width.
 * @property ProductType $product_type Specifies the product type.
 * @documentable
 * @see https://lsdomainexpired.mjman.net/docs/product_page/ Product page
 * @see https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products/ Displaying a list of products
 * @see https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_grouped_products/
...
class Product extends ActiveRecord
{
    ...
    public static $allowed_sorting_columns = [
        'name',
        'title',
        'price',
        'sku',
    ...
    public $belongs_to = [
        ...
        'master_grouped_product' => [
            'class_name' => 'Shop\Product',
            'foreign_key' => 'product_id'
        ],
        'tax_class' => [
            'class_name' => 'Shop\TaxClass',
            'foreign_key' => 'tax_class_id'
        ],
        'product_type' => [
            'class_name' => 'Shop\ProductType',
            'foreign_key' => 'product_type_id'
        ],
        'manufacturer_link' => [
            'class_name' => 'Shop\Manufacturer',
    ...
    public $has_and_belongs_to_many = [
        'categories' => [
            'class_name' => 'Shop\Category',
            'join_table' => 'shop_products_categories',
            'order' => 'name'
        ],
        'customer_groups' => [
            'class_name' => 'Shop\CustomerGroup',
            'join_table' => 'shop_products_customer_groups',
            'order' => 'name',
            'foreign_key' => 'customer_group_id',
            'primary_key' => 'shop_product_id'
        ],
        'related_products_all' => [
            'class_name' => 'Shop\Product',
            'join_table' => 'shop_related_products',
            'primary_key' => 'master_product_id',
        ...
        'related_product_list' => [
            ...
            'primary_key' => 'master_product_id',
            'foreign_key' => 'related_product_id',
            'conditions' => ' ((shop_products.enabled = 1
                                AND NOT (shop_products.track_inventory IS NOT NULL
                                ...
                                AND ((shop_products.stock_alert_threshold IS NOT NULL
                                AND shop_products.total_in_stock <= shop_products.stock_alert_threshold)
                                OR (shop_products.stock_alert_threshold IS NULL
                                AND shop_products.total_in_stock <= 0))))
                                OR EXISTS( SELECT 
                                    *
                                FROM
                                ...
                                WHERE
                                    grouped_products.product_id IS NOT NULL
                                        ...
                                        AND NOT (grouped_products.track_inventory IS NOT NULL
                                        ...
                                        AND ((grouped_products.stock_alert_threshold IS NOT NULL
                                        AND grouped_products.total_in_stock <= grouped_products.stock_alert_threshold)
                                        OR (grouped_products.stock_alert_threshold IS NULL
                                        AND grouped_products.total_in_stock <= 0)))))
                                AND (shop_products.disable_completely IS NULL
                                OR shop_products.disable_completely = 0)'
        ],
        'extra_option_sets' => [
            'class_name' => 'Shop\ExtraOptionSet',
            'order' => 'shop_extra_option_sets.name',
            'join_table' => 'shop_products_extra_sets',
            'primary_key' => 'extra_product_id',
            'foreign_key' => 'extra_option_set_id'
        ]
    ];

    public $has_many = [
        'grouped_products_all' => [
            'class_name' => 'Shop\Product',
            'delete' => true,
            'order' => 'grouped_sort_order',
            'foreign_key' => 'product_id'
        ],
        'images' => [
            'class_name' => 'Db\File',
        ...
        'options' => [
            'class_name' => 'Shop\CustomAttribute',
            'foreign_key' => 'product_id',
            'order' => 'sort_order',
            'delete' => true
        ],
        'product_extra_options' => [
            'class_name' => 'Shop\ExtraOption',
            'foreign_key' => 'product_id',
            'delete' => true,
            'order' => 'extra_option_sort_order, id',
            'conditions' => '(option_in_set is null or option_in_set=0)'
        ],
        'properties' => [
            'class_name' => 'Shop\ProductProperty',
            'foreign_key' => 'product_id',
            'order' => 'sort_order',
            'delete' => true
        ],
        'price_tiers' => [
            'class_name' => 'Shop\PriceTier',
            'foreign_key' => 'product_id',
            'order' => '(select name from shop_customer_groups where id=customer_group_id), price desc',
            'delete' => true
        ],
        'bundle_offers_link' => [
            'class_name' => 'Shop\ProductBundleOffer',
            'foreign_key' => 'product_id',
            'order' => 'sort_order',
            'delete' => true
        ],
        'option_matrix_records' => [
            'class_name' => 'Shop\OptionMatrixRecord',
            'foreign_key' => 'product_id',
            'order' => 'shop_option_matrix_records.id',
            'delete' => true
        ],
        ...
        'files' => [
            'class_name' => 'Shop\ProductFile',
            'foreign_key' => 'master_object_id',
            'conditions' => "master_object_class='Shop_Product' and field='files'",
            'order' => 'id',
            'delete' => true
        ],
        'uploaded_files' => [
            'class_name' => 'Db\File',
            'foreign_key' => 'master_object_id',
            'conditions' => "master_object_class='Shop_Product' and field='uploaded_files'",
            'order' => 'id',
            'delete' => true
        ]
    ];
    ...
    public $calculated_columns = [
        'page_url' => [
            'sql' => "cms_pages.url",
            'type' => db_text,
            'join' => ['cms_pages' => 'shop_products.page_id=cms_pages.id']
        ],
        'items_ordered' => [
            'sql' => '0',
            'type' => db_number
        ...
        'grouped_name' => [
            'sql' => 'if (shop_products.grouped = 1, 
                      concat(shop_products.name, " (", shop_products.grouped_option_desc,")"), shop_products.name)',
            'type' => db_text
        ]
    ];

    public $perproduct_shipping_cost = [
        [
            'country' => '*',
            'state' => '*',
            'zip' => '*',
    ...
    public static $proxiable_methods = [
        'get_set_sale_price',
        'eval_tier_price',
        'get_sale_price_no_tax',
        'get_sale_price',
        'is_on_sale',
        'get_sale_reduction',
        'price_no_tax',
    ...
    public function define_columns($context = null)
    {
        ...
        $this->define_column('grouped_name', 'Product')
            ->invisible();

        $this->define_column('url_name', 'URL Name')
            ->validation()
            ->fn('trim')
            ->fn('mb_strtolower')
            ->regexp(
                '/^[0-9a-z_-]*$/i',
                'URL Name can contain only latin characters, numbers and signs -, _, -'
            )
            ->method('validateUrl')
            ->unique(
                'The URL Name "%s" already in use. Please select another URL Name.',
                [$this, 'configure_unique_validator']
            );
        ...
        $this->define_column('description', 'Long Description')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');
        ...
        $this->define_relation_column('page', 'page', 'Custom Page ', db_varchar, $front_end ? null : '@title')
            ->defaultInvisible()
            ->listTitle('Page')
            ->validation();
        ...
        $this->define_relation_column('manufacturer_link', 'manufacturer_link', 'Manufacturer ', db_varchar, '@name')
            ->defaultInvisible()
            ->validation();
        ...
        $this->define_column('price', 'Base Price')->currency(true)
            ->defaultInvisible()
            ->validation()
            ->fn('trim')
            ->required();
        ...
        $this->define_column('disable_completely', 'Disable Completely')
            ->defaultInvisible();

        $this->define_relation_column('tax_class', 'tax_class', 'Tax Class ', db_varchar, $front_end ? null : '@name')
            ->defaultInvisible()
            ->validation()
            ->required('Please select product tax class.');

        $this->define_column('tier_prices_per_customer', 'Take into account previous orders')
            ->defaultInvisible();

        $this->define_column('on_sale', 'On Sale')
            ->defaultInvisible();

        $this->define_column('sale_price_or_discount', 'Sale Price or Discount')
            ->defaultInvisible()
            ->validation()
            ->fn('trim')
            ->method('validate_sale_price_or_discount');

        $this->define_column('sku', 'SKU')
            ->validation()->fn('trim')
            ->required("Please enter the product SKU")
            ->unique('The SKU "%s" is already in use.', [$this, 'configure_unique_validator']);

        $this->define_column('weight', 'Weight')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('width', 'Width')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('height', 'Height')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('depth', 'Depth')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('bulky_shipping_item', 'Bulky Shipping Item')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('enable_perproduct_shipping_cost', 'Enable per product shipping cost')
            ->invisible();

        $this->define_column('perproduct_shipping_cost', 'Shipping cost')
            ->invisible()
            ->validation();

        $this->define_column('perproduct_shipping_cost_use_parent', 'Use parent product per product shipping cost')
            ->invisible();

        $this->define_column('track_inventory', 'Track Inventory')
            ->defaultInvisible();

        $this->define_column('in_stock', 'Units In Stock')
            ->defaultInvisible()
            ->validation()
            ->fn('trim')
            ->method('validate_in_stock');

        $this->define_column('total_in_stock', 'Total Units In Stock')
            ->defaultInvisible();

        $this->define_column('allow_negative_stock_values', 'Allow Negative Stock Values')
            ->defaultInvisible();

        $this->define_column('hide_if_out_of_stock', 'Hide if Out Of Stock')
            ->defaultInvisible();

        $this->define_column('stock_alert_threshold', 'Out of Stock  Threshold')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('low_stock_threshold', 'Low Stock  Threshold')
            ->defaultInvisible()
            ->validation()
            ->fn('trim');

        $this->define_column('expected_availability_date', 'Expected Availability Date')
            ->defaultInvisible()
            ->validation();

        $this->define_column('allow_pre_order', 'Allow pre-order')
            ->defaultInvisible();

        $this->define_column('meta_description', 'Meta Description')
            ->defaultInvisible()
            ->listTitle('Meta Description')
            ->validation()
            ->fn('trim');

        $this->define_column('meta_keywords', 'Meta Keywords')
            ->defaultInvisible()
            ->listTitle('Meta Keywords')
            ->validation()
            ->fn('trim');

        $this->categories_column = $this->define_multi_relation_column(
            'categories',
            'categories',
            'Categories',
            $front_end ? null : '@name'
        )->defaultInvisible()->validation();

        $this->define_multi_relation_column(
            'grouped_products_all',
            'grouped_products_all',
            'Grouped Products',
            $front_end ? null : "@grouped_option_desc"
        )->invisible();

        $this->define_column('grouped_attribute_name', 'Attribute Name')
            ->invisible()
            ->validation()
            ->method('validate_grouped_options');

        $this->define_column('grouped_option_desc', 'This Product Description')
            ->invisible()
            ->validation()
            ->method('validate_grouped_options');

        $this->define_multi_relation_column('options', 'options', 'Options', $front_end ? null : "@name")
            ->invisible();
        ...
        $this->define_multi_relation_column('price_tiers', 'price_tiers', 'Price Tiers', $front_end ? null : "@id")
            ->invisible();
        ...
        $this->define_multi_relation_column('properties', 'properties', 'Properties', $front_end ? null : "@name")
            ->invisible();

        $this->define_multi_relation_column('files', 'files', 'Files', $front_end ? null : '@name')
            ->defaultInvisible();

        $this->define_column('xml_data', 'XML Data')
            ->invisible()
            ->validation()
            ->fn('trim');

        $this->define_column('current_price', 'Price')
            ->invisible();

        $this->define_column('csv_import_parent_sku', 'Grouped - Parent Product SKU')
            ->invisible();

        $this->define_column('csv_related_sku', 'Related Products SKU')
            ->invisible();

        $this->define_column('csv_import_om_flag', 'Option Matrix Record Flag')
            ->invisible();

        $this->define_column('csv_import_om_parent_sku', 'Option Matrix - Parent Product SKU')
            ->invisible();

        $this->define_column('grouped_sort_order', 'Grouped - Sort Order')
            ->invisible();

        $this->define_column('items_ordered', 'Units ordered')
            ->invisible();
        ...
        $this->define_column('enable_customer_group_filter', 'Enable customer group filter')
            ->defaultInvisible();

        $this->define_column('product_rating', 'Rating (Approved)')
            ->defaultInvisible();

        $this->define_column('product_rating_all', 'Rating (All)')
            ->defaultInvisible();

        $this->define_column('visibility_search', 'Visible in search results')
            ->invisible();

        $this->define_column('visibility_catalog', 'Visible in the catalog')
            ->invisible();

        $this->define_column('shipping_hs_code', 'Harmonized System Code')
            ->defaultInvisible();

        $this->define_column('shipping_hs_code_extended', 'Extended Harmonized System Code')
            ->defaultInvisible();

        $this->define_column('net_unit_quantity', 'Net Quantity')
            ->defaultInvisible();

        $this->define_column('net_unit_code', 'Net Quantity Unit')
            ->defaultInvisible();
    ...
    public function define_form_fields($context = null)
    {
        if ($context == 'preview') {
            ...
            $this->add_form_field('sku', 'right')
                ->tab('Product Summary');

            $this->add_form_field('product_type', 'left')
                ->tab('Product Summary')
                ->previewNoRelation();

            $this->add_form_field('manufacturer_link', 'right')
                ->previewNoRelation()
                ->previewNoOptionsMessage('Not assigned')
                ->tab('Product Summary');
            ...
            if (!$this->page) {
                ...
                $this->add_form_field('url_name', 'left')
                    ->tab('Product Summary');

                $this->add_form_field('page', 'right')
                    ->tab('Product Summary')
                    ->previewNoRelation()
                    ->previewLink($this->page_url('/'));
            }

            if ($this->inventory_tracking_enabled()) {
                $this->add_form_field('in_stock')
                    ->tab('Product Summary');
            }
            ...
            if (!$reports_access) {
                $this->add_form_field('title')
                    ->tab('Description');
                $this->add_form_field('short_description')
                    ->tab('Description');
                $this->add_form_field('meta_description')
                    ->tab('Description');
                $this->add_form_field('meta_keywords')
                    ->tab('Description');
            }

            if ($this->grouped_products_all->count) {
                $this->add_form_custom_area('grouped_list')
                    ->tab('Product Summary');
            }

            if ($reports_access) {
                $this->add_form_custom_area('statistics_data')
            ...
            if ($context == 'grouped') {
                $this->add_form_field('grouped_option_desc')
                    ->tab('Product')
                    ->comment(
                        'Enter a description for a option corresponding this product, e.g. "XXL size".',
                        'above'
                    );
            ...
            if ($context != 'grouped') {
                $this->add_form_field('enabled', 'left')
                    ->tab('Product')
                    ->comment(
                        'Use this checkbox to show or hide the product from the website. 
                        This option does not affect grouped products.'
                    );
            } else {
                $this->add_form_field('enabled')
                    ->tab('Product')
                    ->comment('Use this checkbox to show or hide the product from the website.');
            }

            if ($context != 'grouped') {
                $this->add_form_field('disable_completely', 'right')
                    ->tab('Product')
                    ->comment(
                        'Use this checkbox to hide this product and all its grouped products from the website 
                        and Administration Area user interface.'
                    );
            }
            ...
            if ($context != 'grouped') {
                $this->add_form_field('url_name', 'left')->tab('Product')->comment(
                    'Specify the product URL name (for example "cannon_printer") 
                    or leave this field empty if you want to provide a specially designed product page.',
                    'above'
                );
            } else {
            ...
            if ($context != 'grouped' && !$front_end) {
                $this->add_form_field('page', 'right')
                    ->tab('Product')
                    ->emptyOption('<default product page>')
                    ->comment(
                        'You can customize the product landing page. 
                        Select a page, specially designed for this product or leave the default value.',
                        'above'
                    )
            ...
            $this->add_form_field('title')
                ->comment(
                    'Use this field to customize the product page title. 
                    Leave this field empty to use the product name as the page title.',
                    'above'
                )
                ->tab('Product');

            if (!$front_end) {
                $this->add_form_field('tax_class')
                    ->tab('Pricing')
            ...
            $this->add_form_field('price', 'left')
                ->tab('Pricing')
                ->comment(
                    'The product price will be visible on the front-end store. 
                    You can set different prices for different customer groups using the tier price section below.',
                    'above'
                );
            ...
            $this->add_form_field('cost', 'right')
                ->tab('Pricing')
                ->comment(
                    'The product cost will be subtracted from the price to get the revenue value in reports. 
                    Leave this value empty if the revenue should match the product price.',
                    'above'
                );

            $this->add_form_field('on_sale')
                ->tab('Pricing')
                ->comment(
                    'Select to override the catalog price rules for this product 
                    and enter the sale price or discount below directly.',
                    'above'
                );

            $this->add_form_field('sale_price_or_discount')
                ->tab('Pricing')
                ->comment(
                    'You can enter the sale price as a fixed amount (e.g. 5.00), 
                    a discount amount (e.g. -5.00) or a discount percentage (e.g. 25%)',
                    'above'
                );

            $this->add_form_section(null, 'Tier Price')
                ->tab('Pricing');

            $this->add_form_field('tier_prices_per_customer')
                ->tab('Pricing');

            if (!$front_end) {
                $this->add_form_field('price_tiers')
                    ->tab('Pricing')
                    ->renderAs('price_tiers');
            }
            ...
            $field = $this->add_form_field('description')
                ...
                ->renderAs(frm_html)
                ->size('small')
                ->saveCallback('save_item');
            $field->htmlPlugins .= ',save';
            $field->htmlFullWidth = true;
            $editor_config = HtmlEditorConfig::get('shop', 'shop_products_categories');
            ...
            $this->add_form_section(
                'You can use the following net quantity fields to quantify 
                the amount of consumable content contained in this product. 
                This can be used for content description and price breakdowns, eg. price per gram, or price per meter.'
            )
                ->tab('Measurements');

            $this->add_form_field('net_unit_quantity', 'left')
                ->tab('Measurements');

            $this->add_form_field('net_unit_code', 'right')
                ->renderAs(frm_dropdown)
                ->emptyOption('- optional select -')
                ->tab('Measurements');


            $shipping_params = ShippingParams::get();
            if ($shipping_params->enable_hs_codes) {
                $this->add_form_field('shipping_hs_code')
                    ->renderAs(frm_dropdown)
                    ->emptyOption('- please select -')
                    ->cssClassName('search-contains--false')
                    ->tab('Shipping')
                    ->comment(
                        'A six digit tariff code can be selected to facilitate 
                        customs clearance when shipping internationally',
                        'above'
                    );

                $this->add_form_field('shipping_hs_code_extended', 'left')
                    ->renderAs(frm_text)
                    ->tab('Shipping')
                    ->comment(
                        'Enter a full tariff code here if a code longer than 6 digits is required, 
                        or if the code cannot be found in the selection options above.',
                        'above'
                    );
            }

            $this->add_form_field('bulky_shipping_item')
                ->tab('Shipping')
                ->comment('Bulky/oversize items can be excluded from discount offers');

            if ($context == 'grouped') {
                $this->add_form_field('perproduct_shipping_cost_use_parent')
                    ->tab('Shipping');
            }

            $this->add_form_field('enable_perproduct_shipping_cost')
                ->tab('Shipping');

            $this->add_form_field('perproduct_shipping_cost')
                ->tab('Shipping')
                ->renderAs(frm_grid)
                ->gridColumns([
                    'country' => [
                        ...
                        'align' => 'left',
                        'width' => '100',
                        'autocomplete' => ['type' => 'local', 'tokens' => $this->get_ppsc_country_list()]
                    ],
                    'state' => [
                        'title' => 'State/County Code',
                        'align' => 'left',
                        'width' => '120',
                        'autocomplete' => [
                        'type' => 'local',
                        'depends_on' => 'country',
                        'tokens' => $this->get_ppsc_state_list()
                        ]
                    ],
                    'zip' => [
                ...
                ->comment(
                    'Specify a shipping cost for different locations. 
                    The shipping cost for this product will be added to the shipping quote,
                     which is determined by the shipping method that the customer chooses.',
                    'above'
                );

            $this->add_form_field('track_inventory', 'left')
                ->tab('Inventory')
                ->comment('Enable this checkbox if you have limited number of this product in stock.');

            $this->add_form_field('in_stock', 'right')
                ->tab('Inventory')
                ->comment(
                    'Specify how many units of the product there are left in stock at the moment.',
                    'above'
                );

            $this->add_form_field('allow_negative_stock_values', 'left')
                ->tab('Inventory');

            $this->add_form_field('hide_if_out_of_stock', 'left')
                ->tab('Inventory')
                ->comment('Remove the product from the website if is out of stock.', 'below');

            $shop_config = ConfigurationRecord::get();
            $this->add_form_field('low_stock_threshold', 'right')
                ->placeholder($shop_config->default_low_stock_threshold)
                ->tab('Inventory')
                ->comment('The low number of units to set the product status to Low Stock.', 'above');

            $this->add_form_field('allow_pre_order', 'left')
                ->tab('Inventory')
                ->comment('Allow customers to order the product even if it is out of stock.', 'below');

            $this->add_form_field('expected_availability_date', 'left')
                ->tab('Inventory');

            $default_os_threshold = $shop_config->default_out_of_stock_threshold ?: 0;

            $this->add_form_field('stock_alert_threshold', 'right')
                ->placeholder($default_os_threshold)
                ->tab('Inventory')
                ->comment('The low number of units to set the product status to Out of Stock.', 'above');


            if ($context != 'grouped' && !$front_end) {
                $this->add_form_field('categories')
                    ->tab('Categories')
                    ->comment('Select categories the product belongs to.', 'above')
                    ->referenceSort('name')
                    ->optionsHtmlEncode(false)
                    ->cssClasses('height-400');
            }
            ...
            if ($context != 'grouped' && !Phpr::$config->get('DISABLE_GROUPED_PRODUCTS')) {
                $this->add_form_partial('grouped_description')
                    ->tab('Grouped');

                $this->add_form_field('grouped_attribute_name', 'left')
                    ->tab('Grouped')
                    ->comment(
                        'Provide a text label to be displayed near the grouped products drop-down menu, e.g. "Size".',
                        'above'
                    );

                $this->add_form_field('grouped_option_desc', 'right')
                    ->tab('Grouped')
                    ->comment(
                        'Please specify an option description, e.g. "Small size".',
                        'above'
                    );

                if (!$front_end) {
                    $this->add_form_field('grouped_products_all')
                        ->tab('Grouped');
                }
            }

            $this->add_form_partial('options_description')
                ->tab('Options');

            if (!$front_end) {
                $this->add_form_field('options')
                    ->tab('Options')
                    ->renderAs('options');
            }

            $this->add_form_partial('extras_description')
                ->tab('Extras');

            if (!$front_end) {
                $this->add_form_field('product_extra_options')
                    ->tab('Extras');

                $this->add_form_field('extra_option_sets')
                    ->tab('Extras')
                    ->noOptions(
                        'Global extra option sets are not defined. 
                        You can create option sets on the Shop/Products/Manage extra option sets page.'
                    )
                    ->comment('Select global extra option sets you want to include to this product.', 'above');

                $this->add_form_partial('properties_description')->tab('Properties');
                $this->add_form_field('properties')->tab('Properties');
            }

            $this->add_form_field('xml_data')
                ->tab('XML Data')
            ...
            if ($context != 'grouped' && !$front_end) {
                $this->add_form_partial('related_description')
                    ->tab('Related');

                $this->add_form_field('related_products_all')
                    ->tab('Related')
                    ->renderAs('related');

                $this->add_form_field('visibility_search', 'left')
                    ->tab('Visibility')
                    ->comment('Use this checkbox to make the product visible in search results.');

                $this->add_form_field('visibility_catalog', 'right')
                    ->tab('Visibility')
                    ->comment('Use this checkbox to make the product visible on the catalog pages.');

                $this->add_form_field('enable_customer_group_filter')
                    ->tab('Visibility');

                $this->add_form_field('customer_groups')
                    ->tab('Visibility')
                    ->comment(
                        'Please select customer groups the product should be visible for.',
                        'above'
                    );
            ...
            if (!$this->product_type_id) {
                $this->product_type = ProductType::get_default_type();
    ...
    {
        if ($items === null) {
            $items = Category::list_children_category_proxies(null);
        }
        ...
        foreach ($items as $item) {
            ...
            $this->list_categories_id_options(
                Category::list_children_category_proxies($item->id),
                $result,
                $level + 1,
                $ignore
            );
    ...
    public function validate_sale_price_or_discount($name, $value)
    {
        if (!strlen($value) && $this->on_sale) {
            $this->validation->setError(
                'Please specify a sale price or discount or uncheck the "On Sale" checkbox.',
                $name,
                true
            );
        }
    ...
    public function configure_unique_validator($checker, $product, $deferred_session_key)
    {
        ...
        $filter = 'not (exists(
            select * from db_deferred_bindings 
            where detail_class_name=:class_id 
            and master_relation_name=:relation_name 
            and detail_key_value=shop_products.id) %s)';
        ...
        if ($deferred_session_key) {
            $filter = sprintf($filter, ' or exists(select * 
					...
					where 
						master_binding.detail_class_name=:class_id
						and master_binding.master_relation_name=:relation_name 
						and master_binding.session_key=:session_key
				)');
        } else {
        ...
        if ($product->product_id) {
            $filter .= ' or (shop_products.product_id is not null and shop_products.product_id=:product_id)';
        }

        $filter = '(' . $filter . ')';

        $bind = [
            'class_id' => get_class_id('Shop\Product'),
            'session_key' => $deferred_session_key,
            'product_id' => $product->product_id,
            'relation_name' => 'grouped_products_all'
        ];
        $checker->where($filter, $bind);
    }
    ...
    public function before_delete($id = null)
    {
        ...
        $count = DbHelper::scalar(
            'select count(*) from shop_order_items, shop_orders 
                 where shop_product_id=:id and shop_orders.id = shop_order_items.shop_order_id',
            $bind
        );
        if ($count) {
            throw new ApplicationException('Cannot delete product because there are orders referring to it.');
        }

        $count = DbHelper::scalar(
            'select count(*) from shop_order_items, shop_products, shop_orders 
                 where shop_product_id=shop_products.id and shop_products.grouped is not null 
                 and shop_products.grouped=1 and shop_products.product_id=:id 
                 and shop_orders.id = shop_order_items.shop_order_id',
            $bind
        );
        if ($count) {
            throw new ApplicationException(
                'Cannot delete product because there are orders referring to its grouped products.'
            );
        }
    }
    ...
    {
        if (!$this->grouped) {
            CatalogPriceRule::apply_price_rules($this->id);

            $grouped_ids = DbHelper::queryArray(
                'select id from shop_products where grouped=1 and product_id=:id',
                array('id' => $this->id)
            );
        ...
        if ($this->product_type_id && (!$this->product_type || ($this->product_type_id !== $this->product_type->id))) {
            $this->product_type = ProductType::create()->find($this->product_type_id);
        }
        if ($this->track_inventory && !$this->inventory_tracking_enabled()) {
            ...
            DbHelper::query('UPDATE shop_products SET track_inventory = NULL WHERE id = ?', $this->id);
        }
    ...
    {
        $files = File::create()
            ->where('master_object_class=?', get_class_id($this))
            ->where('master_object_id=?', $this->id)
            ->find_all();
        ...
        DbHelper::query('delete from shop_products_categories where shop_product_id=:id', ['id' => $this->id]);
        DbHelper::query(
            'delete from shop_products_customgroups where shop_product_id=:id',
            ['id' => $this->id]
        );
        DbHelper::query(
            'delete from shop_related_products where master_product_id=:id or related_product_id=:id',
            ['id' => $this->id]
        );
        DbHelper::query('delete from shop_customer_cart_items where product_id=:id', ['id' => $this->id]);
        DbHelper::query('delete from shop_product_price_index where pi_product_id=:id', ['id' => $this->id]);
        DbHelper::query('delete from shop_product_reviews where prv_product_id=:id', ['id' => $this->id]);
    }

    public function after_create()
    {
        if ($this->grouped_sort_order != -1) {
            DbHelper::query('update shop_products set grouped_sort_order=:grouped_sort_order where id=:id', [
    ...
    public function get_manufacturer_link_options($key = -1)
    {
        if ($key != -1) {
            if (strlen($key)) {
                $manufacturer = Manufacturer::create()->find($key);
                if ($manufacturer) {
        ...
        $manufacturers = DbHelper::objectArray('select * from shop_manufacturers order by name');
    ...
    public function copy_product_relations($obj, $session_key, $this_session_key)
    {
        ...
        foreach ($images as $image) {
            ...
            $image_copy->master_object_class = get_class_id($obj);
        ...
        foreach ($files as $file) {
            $file_copy = $file->copy();
            $file_copy->master_object_class = get_class_id($obj);
    ...
    public function copy_fields_to_grouped($edit_session_key, $product_ids, $properties, $post_data = null)
    {
        foreach ($product_ids as $product_id) {
            ...
            $product = Product::create()->find($product_id);
            if (!$product) {
                continue;
            }
            ...
            foreach ($properties as $property_id) {
                switch ($property_id) {
                    ...
                    case 'images':
                        ...
                        foreach ($images as $image) {
                            $image_copy = $image->copy();
                            $image_copy->master_object_class = get_class_id($product);
                            $image_copy->field = $image->field;
                            $image_copy->save();
                    ...
                    case 'files':
                        ...
                        foreach ($files as $file) {
                            $file_copy = $file->copy();
                            $file_copy->master_object_class = get_class_id($product);
                            $file_copy->field = $file->field;
                            $file_copy->save();
                    ...
                    case 'extras':
                        ...
                        if ($post_data && is_array($post_data)) {
                            $classId = get_class_id('Shop\Product');
                            if (array_key_exists($classId, $post_data) && array_key_exists(
                                'extra_option_sets',
                                $post_data[$classId]
                            )) {
                                $extras_sets = $post_data[$classId]['extra_option_sets'];
                            }
                        } else {
                            $extras_set_collection = $this->list_related_records_deferred(
                                'extra_option_sets',
                                $edit_session_key
                            );
    ...
    public function ungroup($parent_product, $session_key = null, $categories = null)
    {
        DbHelper::query(
            'update shop_products 
                 set grouped_attribute_name=:grouped_attribute_name, grouped=null, product_id=null where id=:id',
            ['id' => $this->id, 'grouped_attribute_name' => $parent_product->grouped_attribute_name]
        );
        ...
        if ($categories) {
            foreach ($categories as $category_id) {
                ...
                DbHelper::query(
                    'delete from shop_products_categories 
                          where shop_product_id=:shop_product_id and shop_category_id=:shop_category_id',
                    $bind
                );
                DbHelper::query(
                    'insert into shop_products_categories(shop_product_id, shop_category_id) 
                          values (:shop_product_id, :shop_category_id)',
                    $bind
                );
            }
        }
        ...
        if ($session_key) {
            DeferredBinding::reset_object_field_bindings(
                $parent_product,
                $this,
                'grouped_products_all',
                $session_key
    ...
    public function duplicate_product($grouped_parent = null)
    {
        ...
        foreach ($fields as $column_name => $column_desc) {
            ...
            if (in_array($column_name, $unique_columns)) {
                $column_value = DbHelper::getUniqueColumnValue($copy, $column_name, $column_value);
            }
        ...
        if (!$grouped_parent) {
            ...
            DbHelper::query(
                'update shop_products set product_id = :parent_id where id= :id',
                array('parent_id' => $grouped_parent->id, 'id' => $copy->id)
            );
        }
        ...
        OptionMatrixRecord::copy_records_to_product($this, $copy);
    ...
    {
        DbHelper::query(
            'update shop_products set page_id=:page_id where product_id is not null and product_id=:product_id',
            array(
    ...
    {
        DbHelper::query('update shop_products set in_stock=:value where id=:id', [
            'value' => $value,
            'id' => $product_id
        ]);
     ...
     * Call this method before calling the {@link ActiveRecord::find() find()} or
     * {@link ActiveRecord::find_all() find_all()} method. This method allows to
     * fetch custom product lists from the database, safely that disabled products are not displayed.
     * Usage example:
     * <pre>
     * <?
     *   $products = Product::create()->apply_visibility();
     *
     ...
     * </pre>
     * @documentable
     * @return Product Returns the {@link Product} object.
     * @see Product::apply_customer_visibility() apply_customer_visibility()
     * @see Product::apply_availability() apply_availability()
     * @see Product::apply_filters() apply_filters()
     * @see Product::apply_catalog_visibility() apply_catalog_visibility()
     */
     ...
     * Call this method before calling the {@link ActiveRecord::find() find()} or
     * {@link ActiveRecord::find_all() find_all()} method.
     * Usage example:
     * <pre>
     * <?
     *   $products = Product::create()->apply_customer_group_visibility();
     *
     *   $this->render_partial('shop:product_list', array(
     *   'products'=>$products,
     *   'paginate'=>false
     ...
     * @see Product::apply_availability() apply_availability()
     * @see Product::apply_filters() apply_filters()
     * @see Product::apply_visibility() apply_visibility()
     */
    public function apply_customer_group_visibility()
    {
        $customer_group_id = $this->get_customer_group_context();
        $this->where('
				((shop_products.enable_customer_group_filter is null or shop_products.enable_customer_group_filter=0) 
				or (
					shop_products.enable_customer_group_filter = 1 and
					exists(
					    select * from shop_products_customer_groups 
					    where shop_product_id=shop_products.id and customer_group_id=?
					)
				))
			', $customer_group_id);
        return $this;
     ...
     * <pre>
     * <?
     *   $products = Product::create()->apply_catalog_visibility();
     *
     *   $this->render_partial('shop:product_list', array(
     *   'products'=>$products,
     *   'paginate'=>false
     ...
     * <pre>
     * <?
     *   $products = Product::create()->apply_availability();
     *
     *   $this->render_partial('shop:product_list', array(
     *   'products'=>$products,
     *   'paginate'=>false
     ...
     * </pre>
     * @documentable
     * @param bool $group_products Determines whether grouped product should be returned separately,
     *  or resented with the base product.
    ...
    {
        if ($group_products) {
            $this->where('((shop_products.enabled = 1
                            AND (shop_products.grouped IS NULL
                            OR shop_products.grouped = 0)
                            AND NOT (shop_products.track_inventory IS NOT NULL
                            AND shop_products.track_inventory = 1
                            AND shop_products.hide_if_out_of_stock IS NOT NULL
                            AND shop_products.hide_if_out_of_stock = 1
     ...
     * @documentable
     * @return Product Returns the {@link Product} object.
     * @deprecated Use {@link Product::apply_availability() apply_availability()} method instead.
     */
     ...
     * <pre>
     * <?
     *   $products = Product::create()->apply_filters();
     *
     *   $this->render_partial('shop:product_list', array(
     *   'products'=>$products,
     *   'paginate'=>false
    ...
    public function apply_filters($group_products = true)
    {
        return $this->apply_visibility()
            ->apply_catalog_visibility()
            ->apply_customer_visibility()
            ->apply_availability($group_products);
    }

    /**
     * Set the customer group id which should be used for determining sale prices and filtering
     * @documentable
     * @param int $customer_group_id Specifies the CustomerGroup ID.
     */
    ...
    {
        return $this->customer_group_context = $this->customer_group_context ?: Controller::get_customer_group_id();
    }
     ...
     * <pre>
     * <?
     *   $products = Product::create()->apply_filters()->order_by_price('desc');
     *
     *   $this->render_partial('shop:product_list', array(
     *   'products'=>$products,
     *   'paginate'=>false
     ...
     * @return Product Returns {@link Product} object.
     */
    public function order_by_price($direction = 'asc')
    {
        ...
        $customer_group_id = $this->get_customer_group_context();
        return $this->order(sprintf(Product::$price_sort_query, $customer_group_id) . ' ' . $direction);
    }
    ...
    {
        return TierPrice::list_tier_prices_from_string($this->tier_price_compiled, $this->name);
    }

    public function list_group_price_tiers($group_id)
    {
        return TierPrice::list_group_price_tiers($this->tier_price_compiled, $group_id, $this->name, $this->price);
    }
    ...
    {
        return TierPrice::eval_tier_price(
            $this->tier_price_compiled,
            $group_id,
            $quantity,
            $this->name,
            $this->price
    ...
    public function set_compiled_price_rules($price_rules, $rule_map)
    {
        ...
        DbHelper::query(
            'update shop_products 
                  set price_rules_compiled=:price_rules_compiled, price_rule_map_compiled=:price_rule_map_compiled 
                  where id=:id',
            [
    ...
    {
        DbHelper::query(
            'delete from shop_product_price_index where pi_product_id=:product_id',
            ['product_id' => $this->id]
        );

        $groups = CustomerGroup::list_groups();
        $test_om_record = OptionMatrixRecord::create();

        $om_records = DbHelper::objectArray('
				select 
					on_sale,
        ...
        foreach ($groups as $group_id => $group) {
            ...
            foreach ($om_records as $record_data) {
                $om_price = OptionMatrixRecord::get_sale_price_static(
                    $this,
                    $test_om_record,
                    $record_data,
                    $group_id,
                ...
                if (!$is_on_sale) {
                    $is_on_sale = $om_price < OptionMatrixRecord::get_price_static(
                        $this,
                        $test_om_record,
                        $record_data,
                        $group_id,
        ...
        if ($cnt = count($index_values)) {
            $query = 'insert into shop_product_price_index 
                      (pi_product_id, pi_group_id, price, min_price, max_price, is_on_sale) values';
            foreach ($index_values as $index => $values) {
                $query .= '(' .
                    $this->id . ',' .
                    DbHelper::escape($values['group_id']) . ',' .
                    DbHelper::escape($values['price']) . ',' .
                    DbHelper::escape($values['min_price']) . ',' .
                    DbHelper::escape($values['max_price']) . ',' .
        ...
        DbHelper::query('update shop_products set price_index_compiled=:price_index_compiled where id=:id', array(
            'id' => $this->id,
    ...
    public static function update_rating_fields($product_id)
    {
        DbHelper::query(
            "update shop_products set 
                                product_rating=(
                                    select avg(prv_rating) 
                                    from shop_product_reviews 
                                    where prv_rating is not null 
                                      and prv_product_id=shop_products.id 
                                      and prv_moderation_status=:approved_status
                                    ),
                                product_rating_all=(
                                    select avg(prv_rating) from shop_product_reviews 
                                    where prv_rating is not null 
                                      and prv_product_id=shop_products.id
                                    ),
                                product_rating_review_num=ifnull((
                                    select count(*) from shop_product_reviews 
                                    where prv_rating is not null 
                                      and prv_product_id=shop_products.id 
                                      and prv_moderation_status=:approved_status
                                    ), 0),
                                product_rating_all_review_num=ifnull((
                                    select count(prv_rating) 
                                    from shop_product_reviews 
                                    where prv_rating is not null 
                                      and prv_product_id=shop_products.id
                                    ), 0)
            ...
            [
                'product_id' => $product_id,
                'approved_status' => ProductReview::status_approved
            ]
        );
    }
     ...
     * If there are no price rules defined for the product and no sale price
     * or discount specified, returns the product original price
    ...
    public function get_sale_price_no_tax($quantity, $customer_group_id = null)
    {
        ...
        try {
            ...
            throw new ApplicationException('Error loading price rules for the "' . $this->name . '" product');
        }
        ...
        foreach ($price_tiers as $tier_quantity => $price) {
            if ($tier_quantity <= $quantity) {
                $price = round($price, 2);
                $prices = Backend::$events->fireEvent(
                    'shop:onProductReturnCompiledPrice',
                    $this,
                    $quantity,
                    $customer_group_id,
                    $price
     ...
     * If there are no {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules}
     * applied to the product and there
     * is no sale price specified for the product, the method returns the product base price.
     * The price can include tax if the
     ...
     * option is enabled
     *
     * If you need to get the base product price, without any catalog price rules applied,
     * use the {@link Product::price() price()} method.
     *
     ...
     * </pre>
     * @documentable
     * @param int $quantity Specifies the product quantity.
     * Quantity can affect the price in case if product uses tier pricing.
     * @param int $customer_group_id Specifies an identifier of a {@link CustomerGroup customer group}.
     * @return float Returns the product sale price.
     * @see Product::price() price()
     * @see format_currency()
     */
    public function get_sale_price($quantity = 1, $customer_group_id = null)
    {
        ...
        return TaxClass::get_total_tax($this->tax_class_id, $price) + $price;
    }
     ...
     * @param int $customer_group_id Specifies an identifier of a {@link CustomerGroup customer group}.
     * @return float Returns the product sale price.
     * @deprecated Use the {@link Product::get_sale_price() get_sale_price()} method instead
     */
    ...
    {
        $default_unit = MeasurementUnit::create(); //creates obj with default values
        $unit = null;
     ...
     * @documentable
     * @return bool Returns TRUE if the product is on sale. Returns FALSE otherwise.
     */
    ...
    /**
     * Determines whether the product is on sale.
     * Products considered on sale if there are any active
     * {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules
     * catalog price rules}
     * affecting the product price, or if the product's On Sale checkbox is checked.
     * @documentable
     * @return bool Returns TRUE if the product is on sale. Returns FALSE otherwise.
     * @deprecated Use the {@link Product::is_on_sale() is_on_sale()} method instead.
     */
     ...
     * @see Product::price() price()
     * @see Product::get_sale_price() get_sale_price()
     */
    ...
    protected function custom_relation_save()
    {
        ...
        if ($has_unbind && $has_bind) {
            ...
            if (count($unbind_keys)) {
                $existing_records = DbHelper::objectArray(
                    'select * from shop_products_categories 
                          where shop_product_id=:product_id and shop_category_id in (:unbind_keys)',
                    $bind_data
                );
            ...
            if (count($bind_keys)) {
                foreach ($bind_keys as $category_id) {
                    $sort_order = array_key_exists(
                        $category_id,
                        $preserved_sort_orders
                    ) ? $preserved_sort_orders[$category_id] : null;
                    ...
                    DbHelper::query(
                        'insert into shop_products_categories 
                             (shop_product_id, shop_category_id, product_category_sort_order) 
                             values (:shop_product_id, :shop_category_id, :product_category_sort_order)',
                        $bind_data
                    );
                }
            }
    ...
    public function get_extra_options_merged()
    {
        ...
        return new DataCollection($options);
    }

    public function copy_extra_option_sets($sets)
    {
        DbHelper::query('delete from shop_products_extra_sets where extra_product_id=:id', array('id' => $this->id));

        foreach ($sets as $set_id) {
            DbHelper::query(
                'insert into shop_products_extra_sets
                      (extra_product_id, extra_option_set_id) 
                      values (:extra_product_id, :extra_option_set_id)',
                [
    ...
    public function eval_grouped_product_list()
    {
        ...
        $hideOs = ($master_product->is_out_of_stock() && $master_product->hide_if_out_of_stock);
        if (!$master_product->enabled || $hideOs) {
            return $list;
        }
        ...
        usort($result, array('Shop\Product', 'sort_grouped_products'));
    ...
    public function decrease_stock($quantity, $om_record = null)
    {
        ...
        if (!$use_om_record) {
            ...
            DbHelper::query('update shop_products set in_stock=:in_stock where id=:id', array(
            ...
            DbHelper::query('update shop_option_matrix_records set in_stock=:in_stock where id=:id', array(
        ...
        if ($is_out_of_stock) {
            ...
            $notification_template = ConfigurationRecord::get()->out_of_stock_alert_notification_template;
            ...
            if ($is_low_stock) {
                $notification_template = ConfigurationRecord::get()->low_stock_alert_notification_template;
                //$send_email_template_code = 'shop:low_stock_internal';
            }
        }

        if ($notification_template) {
            $users = Role::get_users_notified_on_out_of_stock();
            if ($users && $users->count) {
                $rUrl = Phpr::$request->getRootUrl();
                $product_url = $rUrl. url('shop/products/edit/' . $this->master_grouped_product_id . '?' . uniqid());
                $message = $this->set_email_variables($notification_template->content, $product_url, $om_record);
                $notification_template->subject = $this->set_email_variables(
    ...
    public function set_email_variables($message, $product_url, $om_record)
    {
        if (!$om_record) {
            ...
            $message = str_replace(
                ...
                h($this->name) . ' (' . h($om_record->options_as_string()) . ')',
                $message
            );
     ...
     * For products which use
     * {@link https://lsdomainexpired.mjman.net/docs/integrating_option_matrix Option Matrix}
     * the base product
     * is considered out of stock in case if all Option Matrix products are out of stock.
     * @documentable
     * @return bool Returns TRUE if the product is out of stock. Returns FALSE otherwise.
     */
    public function is_out_of_stock()
    {
        ...
        if ($this->stock_alert_threshold !== null) {
            if (is_numeric($this->stock_alert_threshold)) {
                $os_threshold = $this->stock_alert_threshold;
            }
        } else {
            $config = ConfigurationRecord::get();
            if (is_numeric($config->default_out_of_stock_threshold)) {
                $os_threshold = $config->default_out_of_stock_threshold;
            }
        }
     ...
     * For products which use
     * {@link https://lsdomainexpired.mjman.net/docs/integrating_option_matrix Option Matrix} the base product
     ...
     * @documentable
     * @return bool Returns TRUE if the products stock level is equal or less than the low stock threshold.
    ...
    public function is_low_stock()
    {
        ...
        if ($low_stock_threshold === null) {
            $config = ConfigurationRecord::get();
            if (is_numeric($config->default_low_stock_threshold)) {
                $low_stock_threshold = $config->default_low_stock_threshold;
            }
        }
     ...
     * @documentable
     * @return int Returns the total number of items in stock.
     */
    public function in_stock_grouped()
    {
        ...
        return DbHelper::scalar(
            'select sum(ifnull(total_in_stock, 0)) 
            from shop_products where id=:id or (product_id is not null and product_id=:id)',
    ...
    public static function update_total_stock_value($product)
    {
        if (is_object($product)) {
            ...
            $matrixStock = DbHelper::scalar(
                'select sum(ifnull(in_stock, 0)) 
                     from shop_option_matrix_records 
                     where product_id=:product_id and (disabled is null or disabled=0)',
                ['product_id' => $product->id]
            );
            if ($matrixStock) {
                $product->total_in_stock += (int) $matrixStock;
            }

            DbHelper::query('update shop_products set total_in_stock=:total_in_stock where id=:id', [
                'total_in_stock' => $product->total_in_stock,
                'id' => $product->id
            ]);
        } else {
            DbHelper::query('update 
					shop_products 
    ...
    public function get_csv_import_columns($import = true)
    {
        ...
        if ($import) {
            $properties = PropertySetProperty::create()->order('name')->find_all();
        } else {
            $properties = ProductProperty::create()->order('name')->find_all();
        }
        ...
        $record = OptionMatrixRecord::create();
    ...
    public static function generate_unique_url_name($name)
    {
        ...
        while (DbHelper::scalar(
            'select count(*) from shop_products where url_name=:url_name',
            array('url_name' => $url_name)
        )) {
    ...
    {
        $countries = Country::get_object_list();
        $result = array();
        $result[] = '* - Any country||*';
    ...
    protected function get_ppsc_state_list()
    {
        ...
        $states = DbHelper::objectArray(
            'select shop_states.code as state_code, shop_states.name, shop_countries.code as country_code
    ...
    protected function validate_shipping_cost()
    {
        ...
        if (!is_array($this->perproduct_shipping_cost) || !count($this->perproduct_shipping_cost)) {
            $this->field_error(
                ...
                'Please specify shipping cost or disable the Per-Product Shipping Cost feature.'
            );
        }
        ...
        foreach ($this->perproduct_shipping_cost as $row_index => &$locations) {
            ...
            if (!strlen($country)) {
                $this->field_error(
                    'perproduct_shipping_cost',
                    'Please specify country code. Valid codes are: ' . implode(', ', $country_codes) . '.',
                    $row_index,
                    'country'
                );
            }
            ...
            if (!array_key_exists($country, $countries) && $country != '*') {
                $this->field_error(
                    'perproduct_shipping_cost',
                    'Invalid country code. Valid codes are: ' . implode(', ', $country_codes) . '.',
                    $row_index,
                    'country'
                );
            }
            ...
            if (!Number::isValidFloat($price)) {
                $this->field_error(
                    'perproduct_shipping_cost',
                    'Invalid numeric value in column Cost',
                    $row_index,
                    'cost'
                );
            }
        ...
        if (!count($processed_locations)) {
            $this->field_error(
                'perproduct_shipping_cost',
                'Please specify shipping cost or disable the Per-Product Shipping Cost option.'
            );
        }
    ...
    public function price_no_tax($quantity = 1, $customer_group_id = null)
    {
        ...
        $price_adjusted = Backend::$events->fire_event(array(
            'name' => 'shop:onGetProductPriceNoTax',
            'type' => 'filter'
        ), array(
            'product' => $this,
            'price' => $price,
     ...
     * The price depends on price tiers and does not depend on
     * {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules}.
     * If you need to get a price calculated with catalog price rules applied,
     * use the {@link Product::get_sale_price() get_sale_price()} method.
     * The price can include tax if the
     * {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/
     * Display catalog/cart prices including tax}
     * option is enabled
     ...
     * grouped products and always taking into account Option Matrix records.
     * Pass TRUE to the <em>$include_grouped_products</em> parameter
     * to include grouped product prices into the calculations.
     * Pass a specific customer group identifier to the <em>$customer_group_id</em> parameter
     * if you want to get the maximum price for a specific customer group.
     * @documentable
     * @param bool $include_grouped_products Determines whether grouped product prices
     * should be considered.
     * @param int $customer_group_id Specifies a {@link CustomerGroup customer group} identifier.
    ...
    /**
     * Returns a {@link https://lsdomainexpired.mjman.net/docs/product_page/ product page} URL,
     * based on the URL passed in the parameter.
     ...
     * it would return strings like <em>/product/red_mug</em> or <em>/product/apple_keyboard</em>.
     ...
     * {@link https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products Displaying a list of products}
     * article for the usage example.
     * @documentable
     * @see https://lsdomainexpired.mjman.net/docs/product_page/ Product page
     * @see https://lsdomainexpired.mjman.net/docs/displaying_a_list_of_products Displaying a list of products
    ...
    {
        $page_url = PageReference::get_page_url($this, 'page_id', $this->page_url);
        ...
        if ($this->om_options_preset && is_object($this->om_options_preset)) {
            ...
            if ($options) {
                foreach ($options as $option_name => $option_value) {
                    $stringField = 'product_options[' . urlencode($option_name) . ']';
                    $stringValue = urlencode($option_value);
                    $option_array[] = $stringField.'='.$stringValue;
                }
     ...
     * Use this method for displaying product images.
     * The <em>$width</em> and <em>$height</em> parameters are thumbnail width and height correspondingly.
     * You can use exact int values, or word <em>'auto'</em> for automatic image resizing.
     * The <em>$as_jpeg</em> parameter allows you to generate
     * PNG images with transparency support.
     * By default the parameter value is TRUE and the method generates a JPEG image. The <em>$params</em>
     * array allows to pass parameters to image processing modules
     * (which handle the {@link core:onProcessImage} event). This method is proxiable.
     * The following line of code outputs a thumbnail of the first product image.
     * The thumbnail width is 100 pixels, and thumbnail height is calculated
     * by LSAPP to keep the original aspect ratio.
     * <pre><img src="<?= $product->image_url(0, 100, 'auto') ?>"/></pre>
     * @documentable
     * @param int $index Specifies the zero-based image index.
     ...
     * @param bool $as_jpeg Determines whether JPEG or PNG image will be created.
     * @param array $params A list of parameters.
     * @return string Returns the image URL relative to the website root.
     * @see File::getThumbnailPath()
     */
     ...
     * The <em>$default_product_url</em> parameter should contain an URL of a default
     * {@link https://lsdomainexpired.mjman.net/docs/product_page/ product page}
     * (see the {@link Product::page_url() page_url()} method description).
     * @documentable
     * @see https://lsdomainexpired.mjman.net/docs/product_page/ Product page
     ...
     * @param int $record_number Returns a number of items to return in the feed.
    ...
    public static function get_rss($feed_name, $feed_description, $default_product_url, $record_number = 20)
    {
        ...
        $rss = new Rss($feed_name, $root_url, $feed_description, Phpr::$request->getCurrentUrl());
     ...
     * <li><em>manufacturer_ids</em> - an array of {@link Manufacturer manufacturer} identifiers to limit the result
     *   with specific manufacturers.</li>
     * <li><em>options</em> - an array of product options as a name-value list.
     *  Example: <em>array('color'=>'black')</em>.
     *   You can use the <em>wildcard</em> character as an option value if you
     *  want to find all products with a specific option having any value.</li>
     * <li><em>attributes</em> - an array of product attributes as a name-value list.
     *  Example: <em>array('paper format'=>'A4')</em>.
     *   If your products can have multiple attributes with a same name and
     *  you want to search by multiple attribute values,
     *  you can specify the attribute value as array:
     *  <em>array('paper format'=>array('A4', 'A5'))</em> - the method will find products
     *   with the <em>paper format</em> attribute having values of <em>A4</em> or <em>A5</em>.
     *  You can use the <em>wildcard</em>
     *  character for the attribute value if you want to find all products with a
     *  specific attribute having any value.</li>
     ...
     * <li><em>sorting</em> - the product sorting expression, string.
     *  The following values are supported: <em>relevance</em>,
     *   <em>name</em>, <em>price</em>, <em>created_at</em>, <em>product_rating</em>, <em>product_rating_all</em>.
     *   The <em>relevance</em> value is the default sorting option.
     *  The product_rating value corresponds to the approved
     *   product rating, and the product_rating_all value corresponds to the full product rating
     *   (approved and not approved).
     *   All options (except the relevance) support the sorting direction expression -
     *  <em>asc</em> and <em>desc</em>, so you
     *   can use values like "price desc". You can extend the list of allowed sorting columns with the
     * {@link shop:onGetProductSearchSortColumns} event.</li>
     * </ul>
     * Usage example:
     * <pre>
     ...
     *
     * $products = Product::find_products($query, $pagination, $current_page, $options);
     * </pre>
     * By default the find_products() method uses soft comparison in the options and attributes search.
     *  This means that if you specify
     * an option or attribute value <em>large</em> and if there are products which have the option value
     *  <em>large frame</em>, those
     *  product will be returned. You can enable strict search by adding the
     *  <em>exclamation</em> sign before the option or attribute value:
     * <pre>
     * $options['attributes'] = array('CPU'=>'!2.33');
     * $options['options'] = array('color'=>'!black');
     * </pre>
     ...
     * @param \Phpr\Pagination $pagination Specifies the pagination object.
     * @param int $page Specifies a current page index (1-based).
     * @param array $options Specifies search options.
     * @return DataCollection Returns a collection of Product objects.
     * @see https://lsdomainexpired.mjman.net/docs/creating_the_search_page Creating the Search page
    ...
    {
        return ProductSearch::find_products($query, $pagination, $page, $options);
    }
    ...
    public static function check_price_range($test_product, $product, $min_price, $max_price, $test_om_record)
    {
        ...
        if ($product->om_data_fields) {
            $product_price = OptionMatrixRecord::get_sale_price_static(
                $test_product,
                $test_om_record,
                $product->om_data_fields
            );
        }
     ...
     * @return Product Returns an object of the {@link Product} class.
     * @deprecated Use {@link Product::list_on_sale() list_on_sale()} method instead.
     * @documentable
     */
    ...
    /**
     * Returns a list of products on sale.
     * Products on sale include products with any
     * {@link https://lsdomainexpired.mjman.net/docs/catalog_level_price_rules catalog price rules} applied
     * or with a sale price or discount specified directly on the product configuration page.
     * The method returns an instance of the {@link Product} class. To obtain a collection of products call the
     * {@link ActiveRecord::find_all() find_all()} method of the returned object.
     * The <em>$options</em> parameter allows to specify the sorting mode with the <em>sorting</em> element.
     * This element should contain an array
     ...
     * </ul>
     * You can add <em>desc</em> suffix to the sort column name to enable the descending sorting.
     * For example, to sort the product list
     * by price in descending order. Example:
     * <pre>$products = Product::list_on_sale(array('sorting'=>array('price desc')))->limit(10)->find_all();</pre>
     * Another supported option is the <em>group_products</em>.
     * It default value is TRUE and the method returns only base products.
     * Pass FALSE to the option to include grouped products to the result.
     * <pre>$products = Product::list_on_sale(array('group_products'=>false))->limit(10)->find_all();</pre>
     * @documentable
     * @see https://lsdomainexpired.mjman.net/docs/displaying_products_on_sale Displaying products on sale
     * @param array $options Specifies the method options.
     * @return Product Returns an object of the {@link Product} class.
     */
    public static function list_on_sale($options = array())
    {
        ...
        $obj->where(sprintf(Product::$is_on_sale_query, $obj->get_customer_group_context()) . ' = 1');
        ...
        foreach ($sorting as &$sorting_column) {
            ...
            if (!in_array($test_name, Product::$allowed_sorting_columns)) {
                continue;
            }

            if (strpos($sorting_column, 'price') !== false) {
                $sorting_column = str_replace(
                    'price',
                    sprintf(Product::$price_sort_query, $obj->get_customer_group_context()),
                    $sorting_column
                );
    ...
    public function visible_for_customer()
    {
        ...
        $results = Backend::$events->fire_event(array(
            'name' => 'shop:onProductVisibleForCustomer',
            'type' => 'combine'
        ), array(
            'product' => $this,
            'customer' => $customer,
    ...
    public function visible_for_customer_group($group_id)
    {
        ...
        return DbHelper::scalar(
            'select count(*) from shop_products_customer_groups 
                 where shop_product_id=:product_id and customer_group_id=:group_id',
            [
                'product_id' => $this->id,
                'group_id' => $group_id
            ]
     ...
     * The method returns the configured Product class. Call the {@link ActiveRecord::find_all() find_all()} method of
     * the return object in order to obtain a {@link DataCollection collection} of related products.
     * Usage example:
     * <pre>
     * <?
     ...
     * </pre>
     * @documentable
     * @see https://lsdomainexpired.mjman.net/docs/displaying_related_products/ Displaying related products
     * @return Product Returns an object of the {@link Product} class.
     */
    ...
    public function list_grouped_products()
    {
        ...
        usort($all_grouped_products, array('Shop\Product', 'sort_grouped_products'));
     ...
     * The method returns a nested array. Indexes in the array represent group names.
     * Values represent {@link ExtraOption extra option objects}
     * belonging to the group. Result example:
     * <em>array('Group name 1'=>array(ExtraOption, ExtraOption), 'Group name 2'=>array(ExtraOption))</em>.
     * @documentable
     * @see https://lsdomainexpired.mjman.net/docs/displaying_product_extra_options/ Displaying product extra options
     * @return array Returns an array of extra option group names and extra option objects ({@link ExtraOption}).
     */
     ...
     * @return object ProductProperty Returns the property object. Returns NULL if the property is not found.
     */
     ...
     * </pre>
     * @documentable
     * @param int $customer_group_id Specifies the {@link CustomerGroup customer group} identifier.
     * Omit this parameter to use a group of the currently logged in customer.
     * @return array Returns an array of CatalogPriceRule objects.
     */
    public function list_applied_catalog_rules($group_id = null)
    {
        ...
        try {
            ...
            throw new ApplicationException('Error loading price rule list for the "' . $this->name . '" product');
        }
        ...
        foreach ($rule_map[$group_id] as $rule_id) {
            $result[] = CatalogPriceRule::find_rule_by_id($rule_id);
        }
     ...
     * than the Product::$categories and Product::$category_list fields.
    ...
    public function list_categories()
    {
        ...
        $category_ids = DbHelper::scalarArray(
            'select shop_category_id from shop_products_categories where shop_product_id=:id',
            array('id' => $master_product_id)
        );

        $this->category_cache = array();
        foreach ($category_ids as $category_id) {
            $category = Category::find_category($category_id, false);
            if ($category) {
                $this->category_cache[] = $category;
            }
        }

        $this->category_cache = new DataCollection($this->category_cache);
        return $this->category_cache;
    }
     ...
     * @documentable
     * @return DataCollection Returns a collection of {@link ProductReview} objects.
     * @see Product::list_reviews() list_reviews()
     */
    public function list_all_reviews()
    {
        $product_id = $this->grouped ? $this->product_id : $this->id;

        return ProductReview::create()->where('prv_product_id=?', $product_id)->order('created_at')->find_all();
    }
     ...
     * @documentable
     * @return DataCollection Returns a collection of {@link ProductReview} objects.
     * @see Product::list_all_reviews() list_all_reviews()
     */
    public function list_reviews()
    {
        $product_id = $this->grouped ? $this->product_id : $this->id;

        $obj = ProductReview::create()->where('prv_product_id=?', $product_id);
        $obj->where('prv_moderation_status=?', ProductReview::status_approved);
        return $obj->order('created_at')->find_all();
    }

    /**
     * Returns a list of files uploaded by a customer.
     * This method is applicable only on the
     * {@link https://lsdomainexpired.mjman.net/docs/product_page Product Details} page. Please see
     ...
     * If the key is not provided, the method uses a POSTed key value.
     * @return DataCollection Returns a collection of {@link File} objects.
     */
    ...
    public function add_file_from_post($file_info, $session_key = null)
    {
        ...
        Upload::validateUploadedFile($file_info);

        $file = File::create();
        $file->is_public = false;

        $file->fromPost($file_info);
        $file->master_object_class = get_class_id($this);
    ...
    public function delete_uploaded_file($file_id, $session_key = null)
    {
        ...
        if ($file = File::create()->find($file_id)) {
    ...
    {
        if (!strlen($sale_price_or_discount) || self::is_sale_price_or_discount_invalid($sale_price_or_discount)) {
        ...
        } elseif (Number::isValidFloat($sale_price_or_discount)) {
     ...
     * Valid values are numbers (as the set sale price e.g. 5.5, 6, 12.54),
     * negative numbers (as the set sale discount e.g. -5, -12.22)
     * or percentages (as the discount percentage, values between 0% and 100%).
     * @param string sale price or discount to check
     * @param numeric product price, optional (when this parameter is supplied,
     * function checks that the sale price or discount is not greater than the original price)
    ...
    public static function is_sale_price_or_discount_invalid($value, $price = null)
    {
        ...
        if ($percentage_sign !== false) {
            ...
            if (!Number::isValidFloat($sale_discount) || $sale_discount > 100) {
                return 'Sale discount should be a valid number between 0% and 100%.';
            }
        } else {
            if (!Number::isValidFloat($value)) {
     ...
     * @return bool Returns TRUE if the specified option exists.
     */
     ...
     * @param string $option_key Specifies option key.
     * @return CustomAttribute Returns option object or NULL if
     ...
     * @param mixed $options Specifies product option values or OptionMatrixRecord object.
    ...
    public function has_om_records()
    {
        ...
        return $this->has_om_records =
            DbHelper::scalar(
                'select count(*) from shop_option_matrix_records where product_id=:product_id',
                ['product_id' => $this->id]
            ) ? true : false;
    }
    ...
    public function normalize_posted_options($options)
    {
        ...
        if (ConfigurationRecord::get()->strict_option_values && $this->has_om_records()) {
            $option_record = OptionMatrixRecord::find_record($options, $this, true);
            if (!$option_record || $option_record->disabled) {
                $posted_options = $options;

                if (Controller::get_instance()) {
                    foreach ($this->options as $option) {
                        $updated_values = OptionMatrixRecord::get_first_available_value_set(
                            $this,
                            $option,
                            $posted_options
                        );
     ...
     * @param bool $return_first_enabled_om_record Determines whether the function should
     ...
     * It supports all product class properties.
     * If the method cannot find the specified property in Option Matrix product
     * or if Option Matrix property value is empty, the method automatically falls back to the base product
     * property value.
     * The method supports a list of special property names (which exist as methods in the Product class):
     * <ul>
     *   <li><em>price</em> - returns the base price, taking into account tier price configuration.
     * If Option Matrix product has no its own price value,
     ...
     *   <li><em>disabled</em> - returns Option Matrix product's Disabled flag value.
     * The value is TRUE if Option Matrix product corresponding to the
     *     options passed to the second parameter of om() method does not exist.</li>
     *   <li><em>is_out_of_stock</em> - returns TRUE if Option Matrix product is out of stock.
     * Option Matrix products follow the base product's inventory
     *     tracking configuration.</li>
     *   <li><em>is_on_sale</em>
     *  - returns TRUE if there are any catalog price rules applied to the Option Matrix or base product
     * (i.e. if its sale price doesn't match the base price).</li>
     *   <li><em>expected_availability_date</em>
     *  - returns the expected availability date as {@link PhprDateTime} object.
     * If the expected availability
     ...
     *   </li>
     *   <li><em>images</em> - returns a collection of Option Matrix product images
     * (see {@link Product::images images} property of
     *     {@link Product} class). If there are no images in the Option Matrix product,
     * falls back to the base product's images.</li>
     * </ul>
     ...
     * <em>['option_key_1'=>'option value 1', 'option_key_2'=>'option value 2']</em>.
     * Almost always you should use {@link ProductHelper}
     * class to load current product's options. Usage example:
     * <pre>
     * $posted_options = ProductHelper::get_default_options($product);
    ...
    public function om($property_name, $options = null)
    {
        ...
        return OptionMatrix::get_property($options, $property_name, $this, true);
    }
    ...
    public function get_shipping_hs_code_options($keyValue = -1)
    {
        ...
        if ($keyValue == -1) {
            ...
            $name = DbHelper::scalar(
                "SELECT CONCAT(description,' [ ',code,' ]') as value FROM shop_shipping_hs_codes WHERE code = ?",
                $keyValue
            );
    ...
    protected function list_shipping_hs_code_options()
    {
        ...
        $result = DbHelper::queryArray($sql);
        $options = array();
    ...
    /**
     * @deprecated Use {@link Product::copy_product_relations()} method instead.
     */
    ...
    /**
     * @deprecated Use {@link Product::get_copy_fields()} method instead.
     */
    ...
    /**
     * @deprecated Use {@link Product::copy_fields_to_grouped()} method instead.
     */
    ...
    /**
     * @deprecated Use {@link Product::get_property_value()} method instead.
     */
     ...
     * {@link https://lsdomainexpired.mjman.net/docs/lemonstand_module_templates Module Templates}
     * documentation section.
     * The event handler should accept a single parameter - the product object. To add new columns to the product model,
     * call the {@link ActiveRecord::define_column() define_column()} method of the product object.
     ...
     * @param Product $product Specifies the product object.
     * @author LSAPP - MJMAN
     ...
     * To add new fields to the product form, call the
     ...
     * {@link shop:onExtendProductForm} event.
     ...
     * {@link Category::list_products()}, {@link CustomGroup::list_products()},
     * {@link Manufacturer::list_products()}.
     ...
     * @param Product $product Specifies the product object.
     * @param OptionMatrixRecord $om_record Specifies the Option Matrix record, if applicable.
     * @package shop.events
     * @author LSAPP - MJMAN
     */
     ...
     *   <li><em>product</em> - a {@link Product} object, a product the price is being calculated for.</li>
     *   <li><em>quantity</em> - number of products to calculate the price for (if tier pricing is used).</li>
     *   <li><em>customer_group_id</em> - identifier of a
     * {@link CustomerGroup customer group} the price is being calculated for.</li>
     * </ul>
    ...
    /**
     * Triggered before a file is added to a product on the
     * {@link https://lsdomainexpired.mjman.net/docs/product_page Product Details} page.
     * Inside the event handler you can validate the uploaded file and trigger an exception if it is needed.
     * Please read
     * {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ this article}
     * to learn about
     ...
     *     throw new ApplicationException('You cannot add more then 3 files');
     * }
     * </pre>
     ...
     * @author LSAPP - MJMAN
     * @param Product $product Specifies the product object.
     * @param File $file Specifies the added file object.
     */
     ...
     * @param Products $controller Specifies the controller object.
     * @author LSAPP - MJMAN
     * @package shop.events
     */
    ...
    /**
     * Allows to load extra CSS or JavaScript files on the Product List, Product Preview,
     * Create/Edit Product and other pages related to product.
     * The event handler should accept a single parameter - the controller object reference.
     * Call addJavaScript() and addCss() methods of the controller object to add references to JavaScript and CSS files.
     * Use paths relative to LSAPP installation URL for your resource files. Example:
     * <pre>
     ...
     * The event handler accepts the back-end controller object and should return a configured {@link Product} object.
     ...
     * {
     *   $product = Product::create()->apply_visibility(); // Hide disabled products
     ...
     * The event handler should accept two parameters - the $options array passed to the
     * {@link Product::find_products()}
     * method the search query string.
     * The handler should return a name of a search event handled in the custom module. Example:
     * <pre>
     * public function subscribeEvents()
     * {
     ...
     * hardcoded the option and group name, but in real conditions you would pass these values
     * via the search options array.
     * <pre>
     ...
     *   $value = 'Red';
     *
     *   $extra_group = DbHelper::escape($extra_group);
     *   $value = DbHelper::escape($value);
     *
     *   $group_query = "(
     *     exists(
     *       select
     ...
     *   )";
     *
     *   return Product::set_search_query_params($template, '%TABLES%', $group_query.' and %FILTER%');
     * }
     * </pre>
     * Note that the code uses the Product::set_search_query_params() method.
     * This method formats the product search query
     * template by adding new items to the table list and to the filters clause.
     * This event affects the {@link https://lsdomainexpired.mjman.net/docs/creating_the_search_page Search Page} and
     * {@link Product::find_products()} method.
     * @event shop:onRegisterProductSearchEvent
     * @see https://lsdomainexpired.mjman.net/docs/creating_the_search_page Search Page
     * @package shop.events
     * @author LSAPP - MJMAN
     ...
     * @param array $image_root_dir Path to the images directory in the ZIP file or in the images directory
     *  (if specified in the import configuration)
     * @see shop:onAfterCsvProductCreated
     * @see shop:onAfterCsvCustomerCreated
     * @see shop:onAfterCsvCustomerUpdated
     * @see shop:onOverrideProductCategoryCsvImportData
     ...
     * @author LSAPP - MJMAN
     */
    private function event_onAfterCsvOptionMatrixImport(
        $result,
        $fields,
        $product_id,
        $record_options,
     ...
     *      'shop:onOverrideProductCategoryCsvImportData',
     *      $this,
     *      'onOverrideProductCategoryCsvImportData'
     *  );
     * }
     *
     * public function onOverrideProductCategoryCsvImportData($value)
     * {
     ...
     * This event overrides sale prices defined with Catalog Price Rules
     * and with the Sale Price or Discount field in the
     ...
     * @param Product $src_product Specifies the original product object.
    ...
    /**
     * Allows to add new sorting columns to the  {@link Product::find_products find_products} method.
     * The handler should return an array of column names of the shop_products table, including custom fields. Example:
     * <pre>
     * public function subscribeEvents()
     * {
     ...
     * @param Product $product The product object onto which additional where() conditions can be applied.

<?
	 ...
	 * This field can be used for customize the order list on the {@link https://lsdomainexpired.mjman.net/docs/customer_orders_page Customer Orders} page.
	 * @property boolean $notify_customer Determines whether a customer should be notified when an order enters this status.
	 * @property boolean $notify_recipient Determines whether LSAPP users responsible for processing orders with this status should be notified when an order enters this status.
	 * @documentable

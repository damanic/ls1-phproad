<?php
	 ...
	 * @property Db_DataCollection $uploaded_files A collection of files uploaded by the customer on the {@link https://lsdomainexpired.mjman.net/docs/supporting_file_uploads_on_the_product_page/ Product Details} page. 
	...
	class Shop_OrderItem extends Shop_ActiveRecord implements Shop_RetailItem, Shop_BundleItem
	{
		 ...
		 * uses the {@link https://lsdomainexpired.mjman.net/docs/configuring_lemonstand_for_tax_inclusive_environments/ tax inclusive settings}.
		 ...
		 * Below is an event handler example. Similar code used in the {@link https://lsdomainexpired.mjman.net/docs/subscriptions_module Subscriptions Module}: 
		 * <pre>
		 * public function subscribeEvents()
		 * {

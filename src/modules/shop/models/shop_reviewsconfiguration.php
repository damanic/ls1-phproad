<?
	...
	class Shop_ReviewsConfiguration extends Core_Configuration_Model
	{
		...
		protected function build_form()
		{
			...
			$this->add_field('send_notifications', 'Send notifications about new reviews', 'full', db_number)->renderAs(frm_checkbox)->tab('Reviews')->comment("Notifications will be sent to all LSAPP users who have permissions to manage products.", "above");
		}

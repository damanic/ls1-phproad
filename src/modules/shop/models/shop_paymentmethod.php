<?
	...
	class Shop_PaymentMethod extends Db_ActiveRecord
	{
		...
		public function define_columns($context = null)
		{
			...
			$this->define_column('ls_api_code', 'LSAPP API Code')->defaultInvisible()->validation()->fn('trim')->fn('mb_strtolower')->unique('Payment method with the specified LSAPP API code already exists.');
		 ...
		 * This method is used inside the {@link https://lsdomainexpired.mjman.net/docs/implementing_customer_payment_profiles payment proile page}.
		 * @documentable

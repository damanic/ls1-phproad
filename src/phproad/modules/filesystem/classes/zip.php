...
class Zip
{
    public static $chmodError = false;

    protected static $initialized = false;

    public static function zipFile($file, $archive_path)
    {
        self::initZip();
        chdir(dirname($file));
        ...
        @chmod($archive_path, File::getPermissions());
    }
     ...
     */
    public static function zipDirectory($path, $archive_path, $exceptions = array(), $archive = null)
    {
        self::initZip();
        chdir($path);

...
class Util
{
     ...
     * @return mixed[]
     */
    public static function splatKeys($value, $strict = true)
    {
        if (!is_array($value)) {
     ...
     * @return array
     */
    public static function buildArrayFromObject($key, $value, $object)
    {
        $result = array();
        foreach ($object as $o) {
     ...
     * @return array
     */
    public static function unsetValue($array, $item)
    {
    ...
    {
        Phpr::$deprecate->setFunction('splat_keys','splatKeys');
        return self::splatKeys($value, $strict);
    }
}

...
class Url
{
     ...
     *                                   Use this parameter to obtain
     *                                   the absolute URL of a
     *                                   resource. Example:
     *                                   Phpr_Url::siteUrl(
     *                                   'images/button.gif' ) will
     *                                   return
     *                                   http://www.your-company.com/images/button.gifhttp://www.your-company.com/images/button.gif
     *
    ...
    {
        Phpr::$deprecate->setFunction('root_url','rootUrl');
        return self::rootUrl($resource, $add_host_name_and_protocol, $protocol);
    }

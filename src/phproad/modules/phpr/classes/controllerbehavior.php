...
class ControllerBehavior extends Extension
{
    ...
    public function __construct($controller)
    {
        ...
        $this->_viewPath = dirname($refObj->getFileName()) . '/' . strtolower(get_class_id($this)) . '/partials';
     ...
     *                                   by the behavior partial even if the controller partial
     *                                   does exist.
    ...
    protected function renderPartial($viewName, $params = array(), $overrideController = false, $throwNotFound = true)
    {
        $this->renderPartialFile(
            $this->_controller->getViewsDirPath(),
            $viewName,
            $params,
            $overrideController,
            $throwNotFound
     ...
     * @return bool
     */
    protected function renderControllerPartial(
        $controllerClass,
        $viewName,
        $params = array(),

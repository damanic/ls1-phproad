        ...
        for ($i = 0; $i < strlen($source); $i++) {
            if (strlen($this->ansi)) {
                ...
                case "\x1B[J": // Clear screen from cursor down
                    ...
                    $this->history_attrs = array_merge(
                        $this->history_attrs,
                ...
                case "\x1B[K": // Clear screen from cursor right
                    ...
                    array_splice(
                        $this->attrs[$this->y], $this->x + 1, $this->max_x - $this->x,
            ...
            case "\x1B": // start ANSI escape code
                $this->tokenization[count($this->tokenization) - 1] = substr(
    ...
    function _getScreen()
    {
        ...
        for ($i = 0; $i <= $this->max_y; $i++) {
            for ($j = 0; $j <= $this->max_x; $j++) {
                ...
                $output .= $this->_processCoordinate(
                    $last_attr, $cur_attr,
                    isset($this->screen[$i][$j]) ? $this->screen[$i][$j] : ''
                );
    ...
    function getHistory()
    {
        ...
        for ($i = 0; $i < count($this->history); $i++) {
            for ($j = 0; $j <= $this->max_x + 1; $j++) {
                ...
                $scrollback .= $this->_processCoordinate(
                    $last_attr, $cur_attr,
                    isset($this->history[$i][$j]) ? $this->history[$i][$j] : ''
                );
